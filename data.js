...
Critics argue this may weaken mitigation efforts. However, a balanced approach strengthening both adaptation and mitigation is essential.`,
    glossary: [
      { word: "mitigation", pos: "noun", japanese: "緩和（策）", definition: "The action of reducing the severity, seriousness, or painfulness of something", example: "Carbon taxes are a key climate mitigation strategy.", exampleJa: "炭素税は重要な気候緩和戦略である。" },
      { word: "adaptation", pos: "noun", japanese: "適応（策）", definition: "The process of adjusting to new conditions or environment", example: "Coastal cities invest heavily in climate adaptation measures.", exampleJa: "沿岸都市は気候適応策に多額の投資をしている。" },
      { word: "resilience", pos: "noun", japanese: "回復力、レジリエンス", definition: "The capacity to withstand or recover quickly from difficulties", example: "Community resilience depends on strong social networks.", exampleJa: "地域のレジリエンスは強い社会的ネットワークに依存する。" },
      { word: "inertia", pos: "noun", japanese: "慣性、惰性", definition: "A tendency to remain unchanged; resistance to change", example: "Climate inertia means temperatures will keep rising.", exampleJa: "気候の慣性は気温が上がり続けることを意味する。" },
      { word: "inevitable", pos: "adjective", japanese: "避けられない、不可避の", definition: "Certain to happen; unavoidable", example: "Some degree of sea-level rise is now inevitable.", exampleJa: "ある程度の海面上昇はもはや避けられない。" },
      { word: "disproportionately", pos: "adverb", japanese: "不釣り合いに、不均衡に", definition: "To a degree that is too large or too small in comparison with something else", example: "Low-income areas are disproportionately exposed to pollution.", exampleJa: "低所得地域は不均衡に汚染にさらされている。" },
      { word: "preparedness", pos: "noun", japanese: "備え、準備態勢", definition: "The state of being ready for something, especially a disaster", example: "Japan's earthquake preparedness has saved countless lives.", exampleJa: "日本の地震への備えは数えきれない命を救った。" },
      { word: "tangible", pos: "adjective", japanese: "目に見える、具体的な", definition: "Clear and definite; real; perceptible by touch or easily perceived", example: "The reforms produced tangible improvements in test scores.", exampleJa: "改革はテストスコアに具体的な改善をもたらした。" },
      { word: "hazard", pos: "noun", japanese: "危険、ハザード", definition: "A danger or risk", example: "The assessment identified several potential environmental hazards.", exampleJa: "評価はいくつかの潜在的な環境ハザードを特定した。" },
      { word: "drastically", pos: "adverb", japanese: "大幅に、抜本的に", definition: "In a way that is likely to have a strong or far-reaching effect", example: "The company drastically restructured its overseas operations.", exampleJa: "同社は海外事業を抜本的に再編した。" },
      { word: "intensified", pos: "verb/adjective", japanese: "激化した、強まった", definition: "Made or became more intense or stronger", example: "Media coverage intensified as the election approached.", exampleJa: "選挙が近づくにつれ報道が激化した。" },
      { word: "emphasis", pos: "noun", japanese: "重点、強調", definition: "Special importance or prominence given to something", example: "The curriculum places emphasis on interdisciplinary learning.", exampleJa: "カリキュラムは学際的学習に重点を置いている。" },
      { word: "vulnerable", pos: "adjective", japanese: "脆弱な、影響を受けやすい", definition: "Susceptible to physical or emotional attack or harm", example: "Young children are particularly vulnerable to heatwaves.", exampleJa: "幼い子供は熱波に特に影響を受けやすい。" },
      { word: "infrastructure", pos: "noun", japanese: "インフラ、社会基盤", definition: "The basic physical and organizational structures needed for a society to operate", example: "The government announced a major infrastructure modernization plan.", exampleJa: "政府は大規模なインフラ近代化計画を発表した。" }
    ],
...
A prudent approach involves implementing AI incrementally with transparent communication. The most effective deployment augments human capabilities rather than supplanting them entirely.`,
    glossary: [
      { word: "proliferation", pos: "noun", japanese: "急増、拡散", definition: "Rapid increase in numbers or spread", example: "The proliferation of social media transformed news consumption.", exampleJa: "ソーシャルメディアの急増がニュース消費を変えた。" },
      { word: "forethought", pos: "noun", japanese: "事前の熟慮、先見の明", definition: "Careful consideration of what will be necessary or may happen in the future", example: "The architect's forethought allowed future building expansion.", exampleJa: "建築家の先見の明が将来の建物拡張を可能にした。" },
      { word: "unforeseen", pos: "adjective", japanese: "予期しない、想定外の", definition: "Not anticipated or predicted", example: "The merger encountered unforeseen regulatory obstacles.", exampleJa: "合併は想定外の規制上の障害に直面した。" },
      { word: "erosion", pos: "noun", japanese: "浸食、低下", definition: "The gradual destruction or diminishment of something", example: "The erosion of public trust led to regulatory reforms.", exampleJa: "公的信頼の低下が規制改革をもたらした。" },
      { word: "tacit", pos: "adjective", japanese: "暗黙の、言外の", definition: "Understood or implied without being stated", example: "Senior engineers possess tacit knowledge about manufacturing.", exampleJa: "シニアエンジニアは製造に関する暗黙知を持つ。" },
      { word: "codified", pos: "verb", japanese: "体系化された、成文化された", definition: "Arranged into a systematic code or set of rules", example: "Oral traditions were finally codified into written form.", exampleJa: "口承の伝統がついに文書化された。" },
      { word: "displaced", pos: "verb/adjective", japanese: "追いやられた、置き換えられた", definition: "Forced to leave one's usual place or position", example: "Workers displaced by automation enrolled in retraining programs.", exampleJa: "自動化で職を失った労働者が再訓練を受けた。" },
      { word: "prohibitively", pos: "adverb", japanese: "法外に、手が出ないほど", definition: "To such a degree that something becomes impossible or very difficult", example: "Desalination remains prohibitively expensive for developing nations.", exampleJa: "淡水化は発展途上国には法外に高価なままだ。" },
      { word: "exacerbates", pos: "verb", japanese: "悪化させる、深刻化させる", definition: "Makes a problem, bad situation, or negative feeling worse", example: "The housing shortage exacerbates wealth inequality significantly.", exampleJa: "住宅不足は富の不平等を大きく悪化させる。" },
      { word: "disparity", pos: "noun", japanese: "格差、不均衡", definition: "A great difference", example: "The educational disparity between districts persists despite reforms.", exampleJa: "学区間の教育格差は改革にもかかわらず続いている。" },
      { word: "cohesion", pos: "noun", japanese: "結束、まとまり", definition: "The action or fact of forming a united whole", example: "Team cohesion suffered after the organizational restructuring.", exampleJa: "組織再編後にチームの結束が損なわれた。" },
      { word: "obsolescence", pos: "noun", japanese: "陳腐化、時代遅れ", definition: "The process of becoming outdated or no longer used", example: "Rapid obsolescence makes electronics outdated within years.", exampleJa: "急速な陳腐化で電子機器は数年で時代遅れになる。" },
      { word: "perpetual", pos: "adjective", japanese: "絶え間ない、永続的な", definition: "Never ending or changing; occurring repeatedly", example: "The region suffers from perpetual cycles of drought.", exampleJa: "その地域は絶え間ない干ばつの連鎖に苦しんでいる。" },
      { word: "augments", pos: "verb", japanese: "補強する、増強する", definition: "Makes something greater by adding to it; supplements", example: "The software augments physicians' diagnostic capabilities significantly.", exampleJa: "そのソフトウェアは医師の診断能力を大きく増強する。" },
      { word: "supplanting", pos: "verb", japanese: "取って代わること", definition: "Superseding and replacing", example: "Digital payments are gradually supplanting cash transactions.", exampleJa: "デジタル決済が徐々に現金取引に取って代わっている。" },
      { word: "incrementally", pos: "adverb", japanese: "段階的に、漸進的に", definition: "In a way that involves gradual increases or additions", example: "The committee recommended adjusting tax rates incrementally.", exampleJa: "委員会は税率の段階的な調整を推奨した。" },
      { word: "turnover", pos: "noun", japanese: "離職率、人員の入れ替わり", definition: "The rate at which employees leave and are replaced", example: "High turnover prompted management to investigate employee dissatisfaction.", exampleJa: "高い離職率が経営陣に従業員の不満調査を促した。" }
    ],
...
Despite these limitations, central banks remain indispensable. Their credibility anchors public expectations. Yet addressing inflation increasingly requires coordinated international action rather than unilateral monetary intervention.`,
    glossary: [
      { word: "scrutiny", pos: "noun", japanese: "精査、厳密な調査", definition: "Critical observation or examination", example: "The trial data came under intense regulatory scrutiny.", exampleJa: "臨床試験データは厳しい規制当局の精査を受けた。" },
      { word: "intractable", pos: "adjective", japanese: "手に負えない、解決困難な", definition: "Hard to control or deal with; stubbornly resistant to solution", example: "The territorial dispute has proven intractable for decades.", exampleJa: "領土紛争は数十年にわたり解決困難であった。" },
      { word: "bottlenecks", pos: "noun", japanese: "ボトルネック、隘路", definition: "Points of congestion that slow down a process", example: "Port bottlenecks caused weeks of delivery delays.", exampleJa: "港湾のボトルネックが数週間の配送遅延を引き起こした。" },
      { word: "suppress", pos: "verb", japanese: "抑制する、抑え込む", definition: "To forcibly put an end to; to restrain", example: "Rate hikes suppressed spending but hurt housing markets.", exampleJa: "利上げは消費を抑制したが住宅市場を傷つけた。" },
      { word: "precipitate", pos: "verb", japanese: "引き起こす、誘発する", definition: "To cause something to happen suddenly or sooner than expected", example: "The CEO's resignation precipitated a sharp stock decline.", exampleJa: "CEOの辞任が株価の急落を引き起こした。" },
      { word: "susceptible", pos: "adjective", japanese: "影響を受けやすい、脆弱な", definition: "Likely to be influenced or harmed by something", example: "Single-export economies are susceptible to price fluctuations.", exampleJa: "単一輸出経済は価格変動の影響を受けやすい。" },
      { word: "spillover", pos: "noun/adjective", japanese: "波及効果、連鎖反応", definition: "An instance of something spreading beyond its intended area", example: "The crisis had devastating spillover effects on Europe.", exampleJa: "その危機は欧州に壊滅的な波及効果をもたらした。" },
      { word: "depreciate", pos: "verb", japanese: "下落する、価値が下がる", definition: "To diminish in value over time", example: "The lira depreciated sharply against the US dollar.", exampleJa: "リラは米ドルに対して急激に下落した。" },
      { word: "financialization", pos: "noun", japanese: "金融化", definition: "The increasing influence of financial markets and institutions on economic policy and outcomes", example: "Financialization transformed homes into traded investment assets.", exampleJa: "金融化が住宅を取引される投資資産に変えた。" },
      { word: "speculative", pos: "adjective", japanese: "投機的な", definition: "Involving a high degree of risk; based on conjecture rather than knowledge", example: "Speculative cryptocurrency trading drew regulatory attention.", exampleJa: "投機的な暗号通貨取引が規制当局の注目を集めた。" },
      { word: "counteract", pos: "verb", japanese: "対抗する、打ち消す", definition: "To act against something in order to reduce its force or neutralize it", example: "Food subsidies were introduced to counteract rising prices.", exampleJa: "食料補助金が価格上昇に対抗するため導入された。" },
      { word: "expansionary", pos: "adjective", japanese: "拡張的な、景気刺激的な", definition: "Tending toward or relating to economic expansion, especially through increased government spending", example: "The expansionary fiscal stance widened the budget deficit.", exampleJa: "拡張的な財政姿勢が財政赤字を拡大させた。" },
      { word: "dilute", pos: "verb", japanese: "薄める、弱める", definition: "To make something weaker or less effective", example: "Too many priorities dilute the organization's strategic focus.", exampleJa: "優先事項が多すぎると組織の戦略的焦点が薄れる。" },
      { word: "indispensable", pos: "adjective", japanese: "不可欠な、欠くことのできない", definition: "Absolutely necessary", example: "Human interpreters remain indispensable in diplomatic negotiations.", exampleJa: "外交交渉では人間の通訳者が依然として不可欠だ。" },
      { word: "anchors", pos: "verb", japanese: "固定する、支える", definition: "Provides a firm basis or foundation for", example: "The inflation target anchors market expectations effectively.", exampleJa: "インフレ目標が市場の期待を効果的に固定する。" },
      { word: "unilateral", pos: "adjective", japanese: "一方的な、単独の", definition: "Performed by or affecting only one party", example: "The unilateral tariff decision drew sharp international criticism.", exampleJa: "一方的な関税決定が厳しい国際的批判を招いた。" }
    ],
...
DR. OKAFOR: Intentional curation of one's digital environment is paramount. Establish temporal boundaries and audit how platforms make you feel.`,
    glossary: [
      { word: "resonates", pos: "verb", japanese: "共鳴する、心に響く", definition: "Evokes images, memories, or emotions in someone", example: "Her story resonates deeply with struggling professionals.", exampleJa: "彼女の話は苦境にある専門家たちに深く響く。" },
      { word: "consensus", pos: "noun", japanese: "合意、総意", definition: "A general agreement among a group of people", example: "The panel finally reached a consensus on emissions targets.", exampleJa: "パネルはついに排出目標について合意に達した。" },
      { word: "empirical", pos: "adjective", japanese: "実証的な、経験に基づく", definition: "Based on observation or experience rather than theory or pure logic", example: "The study provided robust empirical evidence for effectiveness.", exampleJa: "その研究は有効性の堅固な実証的証拠を提供した。" },
      { word: "intricate", pos: "adjective", japanese: "複雑な、入り組んだ", definition: "Very complicated or detailed", example: "The intricate trade agreements took years to finalize.", exampleJa: "入り組んだ貿易協定は最終化に何年もかかった。" },
      { word: "detrimental", pos: "adjective", japanese: "有害な、不利な", definition: "Tending to cause harm", example: "Excessive screen time is detrimental to children's development.", exampleJa: "過度なスクリーン使用は子供の発達に有害だ。" },
      { word: "cultivate", pos: "verb", japanese: "育む、養う", definition: "To try to develop or improve something", example: "Successful investors cultivate extensive industry networks.", exampleJa: "成功した投資家は広範な業界ネットワークを育む。" },
      { word: "curated", pos: "adjective", japanese: "厳選された、取捨選択された", definition: "Carefully chosen and presented", example: "The curated exhibition attracted half a million visitors.", exampleJa: "厳選された展覧会は50万人の来場者を集めた。" },
      { word: "ramifications", pos: "noun", japanese: "派生的影響、結果", definition: "Complex consequences of an action or event", example: "The court ruling's legal ramifications are still unfolding.", exampleJa: "裁判所の判決の法的波及効果はまだ展開中だ。" },
      { word: "diminished", pos: "adjective/verb", japanese: "減少した、低下した", definition: "Made smaller or less", example: "Her diminished visibility only increased public curiosity.", exampleJa: "彼女の存在感の低下はかえって世間の好奇心を高めた。" },
      { word: "democratized", pos: "verb", japanese: "民主化した、広く利用可能にした", definition: "Made accessible to everyone", example: "Free online courses have democratized higher education.", exampleJa: "無料オンラインコースが高等教育を民主化した。" },
      { word: "marginalized", pos: "adjective", japanese: "疎外された、周縁化された", definition: "Treated as insignificant or pushed to the edge of society", example: "The policy targets historically marginalized communities.", exampleJa: "その政策は歴史的に疎外されたコミュニティを対象とする。" },
      { word: "solidarity", pos: "noun", japanese: "連帯、結束", definition: "Unity or agreement of feeling or action among a group", example: "Workers demonstrated solidarity with the striking teachers.", exampleJa: "労働者たちがストライキ中の教師との連帯を示した。" },
      { word: "insidious", pos: "adjective", japanese: "陰湿な、知らぬ間に進行する", definition: "Proceeding in a gradual, subtle way but with harmful effects", example: "The insidious spread of misinformation erodes public trust.", exampleJa: "偽情報の陰湿な拡散が公的信頼を蝕んでいる。" },
      { word: "amplification", pos: "noun", japanese: "増幅、拡大", definition: "The process of increasing the volume or strength of something", example: "Algorithmic amplification rewards clickbait over real journalism.", exampleJa: "アルゴリズムの増幅がジャーナリズムよりクリックベイトを優遇する。" },
      { word: "provocative", pos: "adjective", japanese: "挑発的な、刺激的な", definition: "Causing annoyance, anger, or strong reaction deliberately", example: "The provocative art installation sparked fierce public debate.", exampleJa: "挑発的なアート展示が激しい公的議論を巻き起こした。" },
      { word: "predisposition", pos: "noun", japanese: "素因、傾向", definition: "A tendency to think or act in a particular way", example: "Genetic markers indicate a predisposition toward heart disease.", exampleJa: "遺伝子マーカーが心臓病への素因を示している。" },
      { word: "compulsive", pos: "adjective", japanese: "強迫的な、やめられない", definition: "Resulting from or relating to an irresistible urge", example: "Compulsive notification checking shares pathways with addiction.", exampleJa: "強迫的な通知確認は依存症と神経経路を共有する。" },
      { word: "pragmatic", pos: "adjective", japanese: "実用的な、現実的な", definition: "Dealing with things sensibly and realistically", example: "The committee adopted a pragmatic approach to emissions.", exampleJa: "委員会は排出問題に現実的なアプローチを採用した。" },
      { word: "paramount", pos: "adjective", japanese: "最重要の、最優先の", definition: "More important than anything else; supreme", example: "Passenger safety is considered paramount in aviation.", exampleJa: "航空業界では乗客の安全が最重要とされる。" },
      { word: "temporal", pos: "adjective", japanese: "時間的な、一時的な", definition: "Relating to time", example: "Researchers established strict temporal boundaries for experiments.", exampleJa: "研究者たちは実験に厳格な時間的境界を設定した。" }
    ],
...
Elena sealed the envelope. The decision felt neither righteous nor treacherous—simply the irreducible minimum that integrity demanded.`,
    glossary: [
      { word: "oppressive", pos: "adjective", japanese: "圧迫的な、息苦しい", definition: "Weighing heavily on the mind or spirits; causing discomfort by being excessive", example: "The oppressive summer heat forced everyone indoors.", exampleJa: "圧迫的な夏の暑さで全員が屋内に避難した。" },
      { word: "irrefutable", pos: "adjective", japanese: "反論できない、否定しようのない", definition: "Impossible to deny or disprove", example: "The DNA evidence was irrefutable proof of guilt.", exampleJa: "DNA証拠は有罪の反論の余地のない証拠だった。" },
      { word: "embezzlement", pos: "noun", japanese: "横領、着服", definition: "Theft or misappropriation of funds placed in one's trust", example: "The executive faced charges of corporate embezzlement.", exampleJa: "その幹部は企業横領の容疑に問われた。" },
      { word: "meticulously", pos: "adverb", japanese: "細心の注意を払って、綿密に", definition: "In a way that shows great attention to detail; very carefully", example: "She meticulously reviewed every page of the contract.", exampleJa: "彼女は契約書の全ページを綿密に確認した。" },
      { word: "quandary", pos: "noun", japanese: "板挟み、困惑", definition: "A state of perplexity or uncertainty, especially about what to do", example: "The ethical quandary left her unable to sleep.", exampleJa: "倫理的な板挟みで彼女は眠れなかった。" },
      { word: "advocated", pos: "verb", japanese: "支持した、擁護した", definition: "Publicly recommended or supported", example: "He advocated strongly for her promotion last year.", exampleJa: "彼は昨年、彼女の昇進を強く擁護した。" },
      { word: "transgression", pos: "noun", japanese: "違反、罪", definition: "An act that goes against a law, rule, or code of conduct", example: "His transgression violated the company's code of ethics.", exampleJa: "彼の違反は会社の倫理規定に反するものだった。" },
      { word: "reverberate", pos: "verb", japanese: "反響する、波紋を広げる", definition: "To have continuing and serious effects", example: "The scandal reverberated through the entire organization.", exampleJa: "そのスキャンダルは組織全体に波紋を広げた。" },
      { word: "complicit", pos: "adjective", japanese: "共謀の、加担した", definition: "Involved with others in an illegal activity or wrongdoing", example: "Her silence made her complicit in the fraud.", exampleJa: "彼女の沈黙は詐欺への加担を意味した。" },
      { word: "siphoned", pos: "verb", japanese: "吸い上げた、不正に流用した", definition: "Illegally or dishonestly transferred (money or resources)", example: "He siphoned millions from the charity's endowment fund.", exampleJa: "彼は慈善団体の基金から数百万ドルを流用した。" },
      { word: "juxtaposition", pos: "noun", japanese: "並置、対比", definition: "The fact of placing two things close together for contrasting effect", example: "The juxtaposition of wealth and poverty was striking.", exampleJa: "富と貧困の対比は際立っていた。" },
      { word: "monolithic", pos: "adjective", japanese: "一枚岩の、画一的な", definition: "Large, powerful, and intractably uniform", example: "People are not monolithic—they hold contradictory beliefs.", exampleJa: "人間は一枚岩ではなく、矛盾する信念を持つ。" },
      { word: "constellations", pos: "noun", japanese: "星座、集まり（比喩的に）", definition: "Groups of related things; clusters (used metaphorically)", example: "Personality emerges from constellations of competing motivations.", exampleJa: "人格は競合する動機の集合体から生まれる。" },
      { word: "righteous", pos: "adjective", japanese: "正義の、道義的に正しい", definition: "Morally right or justifiable", example: "The whistleblower's actions were praised as righteous.", exampleJa: "内部告発者の行動は正義にかなうと称賛された。" },
      { word: "treacherous", pos: "adjective", japanese: "裏切りの、不誠実な", definition: "Guilty of or involving betrayal or deception", example: "The treacherous mountain pass claimed many lives.", exampleJa: "その危険な山道は多くの命を奪った。" },
      { word: "irreducible", pos: "adjective", japanese: "これ以上減らせない、最小限の", definition: "Not able to be reduced or simplified further", example: "Human dignity is an irreducible moral principle.", exampleJa: "人間の尊厳はこれ以上減らせない道徳的原則である。" }
    ],
...
The EU, Japan, and others aim to bolster their ecosystems, yet replicating the complex supply chains that underpin modern chip production cannot happen instantaneously.`,
    glossary: [
      { word: "consequential", pos: "adjective", japanese: "重大な、重要な", definition: "Important; significant in terms of outcomes or results", example: "The court's ruling was the most consequential this decade.", exampleJa: "その裁判所の判決はこの10年で最も重大だった。" },
      { word: "supremacy", pos: "noun", japanese: "覇権、最高位", definition: "The state of being supreme; highest authority or power", example: "Both nations competed fiercely for technological supremacy.", exampleJa: "両国は技術的覇権をめぐり激しく競争した。" },
      { word: "confers", pos: "verb", japanese: "与える、付与する", definition: "Grants or bestows a title, degree, benefit, or right", example: "A prestigious degree confers advantages in job markets.", exampleJa: "一流大学の学位は就職市場で優位性を付与する。" },
      { word: "tectonic", pos: "adjective", japanese: "地殻変動的な、根本的な", definition: "Relating to large-scale structural changes (often used figuratively)", example: "The energy transition represents a tectonic economic shift.", exampleJa: "エネルギー転換は地殻変動的な経済の転換を表す。" },
      { word: "subsidies", pos: "noun", japanese: "補助金、助成金", definition: "Financial assistance granted by a government to support an industry or business", example: "Agricultural subsidies distort global food prices significantly.", exampleJa: "農業補助金は世界の食料価格を大きく歪める。" },
      { word: "orthodoxy", pos: "noun", japanese: "正統派の考え、定説", definition: "Authorized or generally accepted theory, doctrine, or practice", example: "The advisor challenged the prevailing economic orthodoxy.", exampleJa: "その顧問は支配的な経済の定説に異議を唱えた。" },
      { word: "imperatives", pos: "noun", japanese: "必須事項、至上命令", definition: "Things that are vitally important or urgent; essential requirements", example: "National security imperatives drove the policy change.", exampleJa: "国家安全保障上の至上命令がその政策変更を推進した。" },
      { word: "stringent", pos: "adjective", japanese: "厳格な、厳しい", definition: "Strict, precise, and exacting", example: "The EU imposed stringent data protection regulations.", exampleJa: "EUは厳格なデータ保護規制を課した。" },
      { word: "lithography", pos: "noun", japanese: "リソグラフィー（半導体露光技術）", definition: "A process used in semiconductor manufacturing to transfer circuit patterns onto silicon wafers", example: "Advanced lithography machines cost over $150 million each.", exampleJa: "先端リソグラフィー装置は1台1億5千万ドル以上する。" },
      { word: "ingenuity", pos: "noun", japanese: "創意工夫、独創性", definition: "The quality of being clever, original, and inventive", example: "The team's ingenuity solved the engineering problem quickly.", exampleJa: "チームの創意工夫がその工学的問題を迅速に解決した。" },
      { word: "indigenous", pos: "adjective", japanese: "自国の、固有の", definition: "Originating or occurring naturally in a particular place; native", example: "The country developed indigenous semiconductor manufacturing capabilities.", exampleJa: "その国は自国の半導体製造能力を開発した。" },
      { word: "precarious", pos: "adjective", japanese: "不安定な、危うい", definition: "Not securely held or in position; dangerously likely to fall or collapse", example: "The startup's precarious finances forced difficult decisions.", exampleJa: "スタートアップの不安定な財政が困難な決断を迫った。" },
      { word: "catastrophic", pos: "adjective", japanese: "壊滅的な、破局的な", definition: "Involving or causing sudden great damage or suffering", example: "A grid attack could have catastrophic consequences nationwide.", exampleJa: "送電網への攻撃は全国的に壊滅的な結果を招きうる。" },
      { word: "coercion", pos: "noun", japanese: "強制、強要", definition: "The practice of persuading someone to do something by using force or threats", example: "The regime used economic coercion against neighboring states.", exampleJa: "その政権は近隣諸国に経済的強制を行使した。" },
      { word: "paralyze", pos: "verb", japanese: "麻痺させる、機能停止に陥らせる", definition: "To render unable to function or act", example: "The cyberattack paralyzed the hospital network for days.", exampleJa: "サイバー攻撃が病院ネットワークを数日間麻痺させた。" },
      { word: "bolster", pos: "verb", japanese: "強化する、支援する", definition: "To support or strengthen; prop up", example: "The central bank acted to bolster investor confidence.", exampleJa: "中央銀行は投資家の信頼を強化するために行動した。" },
      { word: "underpin", pos: "verb", japanese: "支える、基盤となる", definition: "To support, justify, or form the basis for", example: "Solid research findings underpin the new health guidelines.", exampleJa: "確かな研究結果が新しい健康ガイドラインの基盤となる。" },
      { word: "instantaneously", pos: "adverb", japanese: "即座に、瞬時に", definition: "Immediately; without any delay", example: "High-frequency algorithms execute thousands of trades instantaneously.", exampleJa: "高頻度アルゴリズムは数千の取引を瞬時に実行する。" }
    ],
...
This perspective has catalyzed vigorous debate. If consciousness arises in organisms with fundamentally different architectures, the substrate-independence hypothesis gains support—with contentious implications for artificial intelligence.`,
    glossary: [
      { word: "cognitively", pos: "adverb", japanese: "認知的に", definition: "In a way that relates to the mental processes of perception, memory, judgment, and reasoning", example: "Children cognitively stimulated early perform better academically.", exampleJa: "早期に認知的刺激を受けた子供は学業成績が良い。" },
      { word: "prerequisites", pos: "noun", japanese: "前提条件、必要条件", definition: "Things that are required as prior conditions for something else to happen or exist", example: "Calculus and algebra are prerequisites for this course.", exampleJa: "微積分と代数がこのコースの前提条件である。" },
      { word: "semi-autonomous", pos: "adjective", japanese: "半自律的な", definition: "Partially self-governing or capable of independent action within certain limits", example: "Regional offices operate as semi-autonomous business units.", exampleJa: "地方オフィスは半自律的な事業ユニットとして運営される。" },
      { word: "decentralized", pos: "adjective", japanese: "分散型の、非中央集権的な", definition: "Distributed away from a central authority or location", example: "Blockchain enables a decentralized system without central authority.", exampleJa: "ブロックチェーンは中央権限なしの分散型システムを可能にする。" },
      { word: "invertebrates", pos: "noun", japanese: "無脊椎動物", definition: "Animals that lack a backbone or spinal column", example: "Corals and jellyfish are ecologically important marine invertebrates.", exampleJa: "サンゴとクラゲは生態学的に重要な海洋無脊椎動物である。" },
      { word: "episodic-like memory", pos: "noun phrase", japanese: "エピソード的記憶", definition: "Memory of specific past events including contextual details such as time and place", example: "Scrub jays show episodic-like memory about cached food.", exampleJa: "カケスは隠した食べ物についてエピソード的記憶を示す。" },
      { word: "markedly", pos: "adverb", japanese: "著しく、顕著に", definition: "To a clearly noticeable extent; significantly", example: "The patient's condition improved markedly after treatment.", exampleJa: "患者の状態は治療後に著しく改善した。" },
      { word: "hallmark", pos: "noun", japanese: "特徴、特質", definition: "A distinguishing characteristic or feature", example: "Rigorous peer review is a hallmark of good science.", exampleJa: "厳格な査読は優れた科学の特質である。" },
      { word: "intrinsic", pos: "adjective", japanese: "内在的な、本質的な", definition: "Belonging naturally; essential; inherent", example: "Intrinsic motivation produces deeper learning than external rewards.", exampleJa: "内在的動機づけは外的報酬より深い学びをもたらす。" },
      { word: "diverged", pos: "verb", japanese: "分岐した", definition: "Separated from a common point and developed in different directions", example: "The two species diverged millions of years ago.", exampleJa: "その二つの種は数百万年前に分岐した。" },
      { word: "convergent", pos: "adjective", japanese: "収斂的な、収束する", definition: "Tending to come together or develop similar characteristics independently", example: "Wings in birds and bats illustrate convergent evolution.", exampleJa: "鳥とコウモリの翼は収斂進化を例示している。" },
      { word: "catalyzed", pos: "verb", japanese: "触発した、促進した", definition: "Caused or accelerated a process or change", example: "Carson's book catalyzed the modern environmental movement.", exampleJa: "カーソンの著書が現代の環境運動を触発した。" },
      { word: "substrate-independence", pos: "noun", japanese: "基質非依存性", definition: "The concept that a process or phenomenon can occur regardless of the specific material it is implemented in", example: "Substrate-independence suggests consciousness could arise in silicon.", exampleJa: "基質非依存性は意識がシリコンでも生じうると示唆する。" },
      { word: "contentious", pos: "adjective", japanese: "論争的な、議論を呼ぶ", definition: "Causing or likely to cause disagreement or argument", example: "Machine consciousness remains a deeply contentious topic.", exampleJa: "機械の意識は依然として非常に論争的なテーマである。" }
    ],
...
Sarah: Consider me convinced. Let's plan an itinerary this weekend.`,
    glossary: [
      { word: "toying with", pos: "phrasal verb", japanese: "〜を考え始めている、検討している", definition: "Casually considering an idea without having made a firm decision", example: "She's been toying with the idea of relocating.", exampleJa: "彼女は転居のアイデアを検討し始めている。" },
      { word: "breathtaking", pos: "adjective", japanese: "息をのむような、壮観な", definition: "Astonishing or awe-inspiring in quality, so as to take one's breath away", example: "The sunrise from the summit was absolutely breathtaking.", exampleJa: "山頂からの日の出は本当に息をのむほどだった。" },
      { word: "logistics", pos: "noun", japanese: "物流、段取り、手配", definition: "The detailed coordination of a complex operation involving many people, facilities, or supplies", example: "The logistics of the international conference were complex.", exampleJa: "国際会議の段取りは複雑だった。" },
      { word: "exorbitantly", pos: "adverb", japanese: "法外に、べらぼうに", definition: "To an unreasonably high degree, especially regarding cost", example: "Hotels during the festival are exorbitantly priced.", exampleJa: "祭りの期間中、ホテルは法外な値段がつく。" },
      { word: "seasoned", pos: "adjective", japanese: "経験豊富な、熟練した", definition: "Having a lot of experience in a particular activity", example: "Even seasoned climbers found the route extremely challenging.", exampleJa: "経験豊富な登山家でさえそのルートは極めて困難だった。" },
      { word: "designated", pos: "adjective", japanese: "指定された", definition: "Officially assigned or appointed for a specific purpose", example: "Only park in the designated areas, please.", exampleJa: "指定された場所にのみ駐車してください。" },
      { word: "daunting", pos: "adjective", japanese: "気後れするような、ひるむような", definition: "Seeming difficult to deal with in anticipation; intimidating", example: "Learning a new language can seem daunting initially.", exampleJa: "新しい言語の習得は最初は気後れするように思える。" },
      { word: "calving", pos: "verb", japanese: "（氷河が）崩落する", definition: "Breaking off chunks of ice from the edge of a glacier", example: "We watched the glacier calving huge ice blocks.", exampleJa: "氷河が巨大な氷塊を崩落させるのを見た。" },
      { word: "jagged", pos: "adjective", japanese: "ギザギザの、鋭い", definition: "Having rough, sharp points protruding; with an unevenly cut or torn edge", example: "Hikers carefully navigated the jagged volcanic terrain.", exampleJa: "ハイカーたちはギザギザの火山地帯を注意深く進んだ。" },
      { word: "windswept", pos: "adjective", japanese: "風にさらされた、吹きさらしの", definition: "Exposed to strong winds with little protection", example: "The windswept cliffs offered dramatic ocean views.", exampleJa: "吹きさらしの崖は劇的な海の景色を見せた。" },
      { word: "ferocious", pos: "adjective", japanese: "猛烈な、激しい", definition: "Savagely fierce, cruel, or violent", example: "The ferocious winds made hiking nearly impossible.", exampleJa: "猛烈な風でハイキングはほぼ不可能だった。" },
      { word: "funiculars", pos: "noun", japanese: "ケーブルカー", definition: "Cable railways operating on steep slopes, using counterbalanced cars on a cable", example: "Lisbon's century-old funiculars are popular tourist attractions.", exampleJa: "リスボンの築100年のケーブルカーは人気の観光名所だ。" },
      { word: "panoramic", pos: "adjective", japanese: "パノラマの、全景の", definition: "Providing a wide, unobstructed view of an extensive area", example: "The rooftop terrace offers panoramic city views.", exampleJa: "屋上テラスからパノラマの街の景色が楽しめる。" },
      { word: "counterpoint", pos: "noun", japanese: "対比、対照", definition: "Something that contrasts with and complements something else", example: "The quiet village was a counterpoint to city life.", exampleJa: "静かな村は都会生活への対比だった。" },
      { word: "itinerary", pos: "noun", japanese: "旅程、旅行計画", definition: "A planned route or journey; a detailed plan for a trip", example: "The agent prepared a detailed two-week travel itinerary.", exampleJa: "旅行代理店が詳細な2週間の旅程を作成した。" }
    ],
...
Critics caution that escalating expenditures divert resources from terrestrial priorities, while proponents argue the technological dividends will yield transformative applications within a generation.`,
    glossary: [
      { word: "reinvigorated", pos: "verb", japanese: "再活性化した、新たな活力を与えた", definition: "Given new energy or strength to something", example: "The new policy reinvigorated public interest in renewable energy.", exampleJa: "新しい政策が再生可能エネルギーへの公共の関心を再活性化した。" },
      { word: "culminates", pos: "verb", japanese: "頂点に達する、集大成となる", definition: "Reaches a climax or point of highest development", example: "The training program culminates in a final certification exam.", exampleJa: "研修プログラムは最終認定試験で集大成を迎える。" },
      { word: "derail", pos: "verb", japanese: "頓挫させる、脱線させる", definition: "To obstruct or prevent a process from continuing on its planned course", example: "Supply chain disruptions threatened to derail the product launch.", exampleJa: "サプライチェーンの混乱が製品発売を頓挫させかけた。" },
      { word: "permanently shadowed", pos: "adjective phrase", japanese: "永久影の", definition: "Areas that never receive direct sunlight due to their topographic position", example: "Permanently shadowed craters may harbor ancient water ice deposits.", exampleJa: "永久影のクレーターには古代の水氷が存在しうる。" },
      { word: "pivotal", pos: "adjective", japanese: "極めて重要な、中枢的な", definition: "Of crucial importance in relation to the development or success of something", example: "The discovery of antibiotics was pivotal for modern medicine.", exampleJa: "抗生物質の発見は現代医学にとって極めて重要だった。" },
      { word: "propellant", pos: "noun", japanese: "推進剤、燃料", definition: "A substance used to provide thrust for propelling a rocket or spacecraft", example: "Engineers developed a less toxic green propellant for rockets.", exampleJa: "エンジニアがロケット用の低毒性グリーン推進剤を開発した。" },
      { word: "hinged on", pos: "phrasal verb", japanese: "〜にかかっていた、〜次第だった", definition: "Depended entirely on", example: "The negotiation's success hinged on reaching a territorial compromise.", exampleJa: "交渉の成否は領土の妥協にかかっていた。" },
      { word: "autonomous", pos: "adjective", japanese: "自律的な、自動の", definition: "Acting independently or having the freedom to do so; self-governing", example: "Fully autonomous vehicles remain a major engineering challenge.", exampleJa: "完全自律型車両は依然として大きな工学的課題だ。" },
      { word: "cornerstone", pos: "noun", japanese: "礎石、基盤", definition: "An important quality or feature on which something is based", example: "Press freedom is a cornerstone of democratic governance.", exampleJa: "報道の自由は民主的統治の礎石である。" },
      { word: "durability", pos: "noun", japanese: "耐久性、持続性", definition: "The ability to withstand wear, pressure, or damage; the quality of lasting over time", example: "Universal coverage ensures the program's political durability.", exampleJa: "普遍的な適用がプログラムの政治的持続性を保証する。" },
      { word: "escalating", pos: "adjective/verb", japanese: "増大する、エスカレートする", definition: "Increasing rapidly in extent or intensity", example: "Escalating drug costs forced patients to seek cheaper alternatives.", exampleJa: "エスカレートする薬価が患者に安価な代替品を求めさせた。" },
      { word: "dividends", pos: "noun", japanese: "恩恵、利益（比喩的）", definition: "Benefits or advantages gained from an investment or action (figurative use)", example: "Early investment in wellness programs is now paying dividends.", exampleJa: "健康プログラムへの早期投資が今や恩恵をもたらしている。" },
      { word: "closed-loop", pos: "adjective", japanese: "閉鎖循環型の", definition: "A system in which outputs are recycled back as inputs, minimizing waste", example: "The station's closed-loop system recycles ninety percent of water.", exampleJa: "ステーションの閉鎖循環型システムは水の90%を再利用する。" }
    ],
...
The practical ramifications are sobering. If free will is illusory, retributive punishment becomes indefensible, and the edifice of criminal responsibility requires reconstruction around consequentialist principles of deterrence and rehabilitation.`,
    glossary: [
      { word: "presuppose", pos: "verb", japanese: "前提とする、予め想定する", definition: "To require as a precondition; to assume beforehand", example: "The model presupposes that all participants have perfect information.", exampleJa: "そのモデルはすべての参加者が完全な情報を持つことを前提としている。" },
      { word: "determinist", pos: "noun/adjective", japanese: "決定論者（の）", definition: "A person who believes that all events are determined by previously existing causes", example: "The determinist argued that all decisions are neurologically inevitable.", exampleJa: "決定論者はすべての決定が神経学的に不可避だと主張した。" },
      { word: "predispositions", pos: "noun", japanese: "素因、傾向", definition: "Tendencies or inclinations toward particular conditions or behaviors, often inherited", example: "Genetic predispositions don't guarantee developing a particular disease.", exampleJa: "遺伝的素因は特定の疾患の発症を保証するものではない。" },
      { word: "neurochemical", pos: "adjective", japanese: "神経化学的な", definition: "Relating to the chemical processes occurring in the nervous system", example: "Researchers identified neurochemical imbalances linked to severe depression.", exampleJa: "研究者は重度のうつ病に関連する神経化学的不均衡を特定した。" },
      { word: "compatibilists", pos: "noun", japanese: "両立論者", definition: "Philosophers who argue that free will and determinism are not mutually exclusive", example: "Compatibilists redefine freedom as acting on one's own reflective judgments.", exampleJa: "両立論者は自由を自らの熟慮に基づく行動と再定義する。" },
      { word: "rebuttal", pos: "noun", japanese: "反論、反駁", definition: "A response that disproves or contradicts an argument", example: "The attorney's rebuttal fundamentally altered the jury's assessment.", exampleJa: "弁護人の反論が陪審員の評価を根本的に変えた。" },
      { word: "metaphysical", pos: "adjective", japanese: "形而上学的な", definition: "Relating to the branch of philosophy concerned with the fundamental nature of reality", example: "The metaphysical debate over abstract objects remains unresolved.", exampleJa: "抽象的対象に関する形而上学的議論は未解決のままだ。" },
      { word: "deliberation", pos: "noun", japanese: "熟考、審議", definition: "Long and careful consideration or discussion before reaching a decision", example: "After intense deliberation, the jury reached a unanimous verdict.", exampleJa: "激しい審議の後、陪審員は全員一致の評決に達した。" },
      { word: "indeterminacy", pos: "noun", japanese: "非決定性、不確定性", definition: "The state of being uncertain or not precisely determined", example: "Quantum indeterminacy suggests some physical events are genuinely random.", exampleJa: "量子的不確定性は一部の物理的事象が真に無作為であることを示唆する。" },
      { word: "retributive", pos: "adjective", japanese: "応報的な、報復的な", definition: "Relating to punishment inflicted as vengeance for a wrongdoing", example: "Reformers argue retributive sentencing has failed to reduce recidivism.", exampleJa: "改革者は応報的量刑が再犯の減少に失敗したと主張する。" },
      { word: "edifice", pos: "noun", japanese: "体系、（大きな）建造物", definition: "A large, imposing building; or a complex system of beliefs (figurative)", example: "Relativity shook the entire edifice of classical physics.", exampleJa: "相対性理論が古典物理学の体系全体を揺るがした。" },
      { word: "consequentialist", pos: "adjective", japanese: "帰結主義的な", definition: "Relating to the ethical theory that judges actions by their outcomes rather than intentions", example: "A consequentialist analysis weighs security benefits against privacy harms.", exampleJa: "帰結主義的分析は安全保障の利益とプライバシーの害を比較衡量する。" },
      { word: "deterrence", pos: "noun", japanese: "抑止、抑止力", definition: "The action of discouraging an action or event through instilling doubt or fear", example: "Nuclear deterrence relies on the credible threat of retaliation.", exampleJa: "核抑止は報復の信頼できる脅威に依存している。" },
      { word: "rehabilitation", pos: "noun", japanese: "更生、リハビリテーション", definition: "The process of restoring someone to a useful life through therapy and education", example: "Scandinavian prisons emphasize rehabilitation over punitive sentencing.", exampleJa: "北欧の刑務所は懲罰的量刑よりも更生を重視する。" }
    ],
...
Intriguingly, second-time founders were not significantly more successful, suggesting survivorship bias inflated the perceived benefits of experience, and the preference for serial founders may be an empirically unfounded heuristic.`,
    glossary: [
      { word: "exhaustive", pos: "adjective", japanese: "徹底的な、網羅的な", definition: "Extremely thorough and comprehensive; examining or including all elements", example: "The committee conducted an exhaustive review of financial records.", exampleJa: "委員会が財務記録の徹底的なレビューを実施した。" },
      { word: "prevailing", pos: "adjective", japanese: "広く行き渡った、支配的な", definition: "Existing at a particular time; most common or widespread", example: "The prevailing sentiment among economists is cautiously optimistic.", exampleJa: "経済学者の間で支配的な見方は慎重ながら楽観的だ。" },
      { word: "mortality", pos: "noun", japanese: "死亡率（ここでは失敗率）", definition: "The state of being subject to death; in business context, the rate of failure", example: "The five-year mortality rate for new restaurants exceeds seventy percent.", exampleJa: "新規レストランの5年以内の廃業率は70%を超える。" },
      { word: "premature scaling", pos: "noun phrase", japanese: "時期尚早な拡大", definition: "Expanding a business too quickly before establishing a proven and sustainable business model", example: "Premature scaling depleted the startup's cash reserves within months.", exampleJa: "時期尚早な拡大が数か月で現金準備金を枯渇させた。" },
      { word: "demise", pos: "noun", japanese: "終焉、消滅", definition: "The end or failure of something; death", example: "Analysts attribute the chain's demise to neglecting e-commerce.", exampleJa: "アナリストはそのチェーンの終焉をEコマース軽視に帰している。" },
      { word: "buoyed", pos: "verb", japanese: "勢いづけられた、鼓舞された", definition: "Made to feel happy or confident; kept afloat", example: "Buoyed by positive reviews, the band launched a world tour.", exampleJa: "好意的な評価に鼓舞され、バンドはワールドツアーを開始した。" },
      { word: "unit economics", pos: "noun phrase", japanese: "ユニットエコノミクス（単位あたりの収支）", definition: "The direct revenues and costs associated with a particular business model on a per-unit basis", example: "Investors grew skeptical when unit economics remained consistently negative.", exampleJa: "ユニットエコノミクスが一貫してマイナスのままで投資家は懐疑的になった。" },
      { word: "irreconcilable", pos: "adjective", japanese: "和解できない、相容れない", definition: "Impossible to resolve or make compatible", example: "Irreconcilable positions on compensation collapsed the merger talks.", exampleJa: "報酬に関する相容れない立場が合併交渉を決裂させた。" },
      { word: "inequitable", pos: "adjective", japanese: "不公平な、不公正な", definition: "Not fair or just; characterized by inequality", example: "The report documented inequitable healthcare access across racial lines.", exampleJa: "報告書は人種間の不公平な医療アクセスを記録した。" },
      { word: "requisite", pos: "adjective", japanese: "必要な、不可欠な", definition: "Made necessary by particular circumstances; required", example: "The applicant possessed all requisite qualifications for the position.", exampleJa: "応募者はそのポジションに必要なすべての資格を有していた。" },
      { word: "survivorship bias", pos: "noun phrase", japanese: "生存者バイアス", definition: "The logical error of focusing on entities that passed a selection process while overlooking those that did not", example: "Survivorship bias leads entrepreneurs to study only successful companies.", exampleJa: "生存者バイアスにより起業家は成功企業のみを研究してしまう。" },
      { word: "heuristic", pos: "noun", japanese: "ヒューリスティック（経験則）", definition: "A practical approach to problem-solving that employs shortcuts to produce adequate though not necessarily optimal solutions", example: "Experienced physicians rely on diagnostic heuristics for rapid assessment.", exampleJa: "経験豊富な医師は迅速な評価に診断ヒューリスティックを用いる。" }
    ],
...
Furthermore, quantitative metrics risk undervaluing intangible qualities—leadership, composure, and the capacity to inspire teammates—that resist algorithmic quantification. The most astute managers recognize that data should complement rather than supplant experienced judgment.`,
    glossary: [
      { word: "statisticians", pos: "noun", japanese: "統計学者", definition: "Experts in the collection, analysis, interpretation, and presentation of numerical data", example: "Statisticians analyzed census data to project population growth trends.", exampleJa: "統計学者が国勢調査データを分析し人口増加の傾向を予測した。" },
      { word: "charismatic", pos: "adjective", japanese: "カリスマ的な", definition: "Exercising a compelling charm that inspires devotion in others", example: "The charismatic founder persuaded skeptical investors to commit funding.", exampleJa: "カリスマ的な創業者が懐疑的な投資家に出資を納得させた。" },
      { word: "proprietary", pos: "adjective", japanese: "独自の、独占的な", definition: "Owned by a particular company and protected by patent or copyright", example: "The company's proprietary formula generated billions in annual revenue.", exampleJa: "同社の独自の製剤が年間数十億の収益を生んだ。" },
      { word: "spatial awareness", pos: "noun phrase", japanese: "空間認識", definition: "Understanding of one's position relative to surrounding objects and spaces", example: "Elite players possess extraordinary spatial awareness under defensive pressure.", exampleJa: "エリート選手はディフェンスのプレッシャー下で並外れた空間認識を持つ。" },
      { word: "dissect", pos: "verb", japanese: "詳細に分析する、解剖する", definition: "To analyze something in minute detail", example: "The critic spent months dissecting the novel's narrative structure.", exampleJa: "批評家は数か月かけて小説の物語構造を詳細に分析した。" },
      { word: "immersive", pos: "adjective", japanese: "没入型の", definition: "Providing a deeply engaging experience that surrounds the participant", example: "The museum's immersive exhibition transported visitors to ancient Rome.", exampleJa: "博物館の没入型展示が訪問者を古代ローマに引き込んだ。" },
      { word: "vulnerabilities", pos: "noun", japanese: "脆弱性、弱点", definition: "Weaknesses that can be exploited by an attacker or competitor", example: "The audit uncovered critical vulnerabilities in legacy software systems.", exampleJa: "監査がレガシーソフトウェアの重大な脆弱性を発見した。" },
      { word: "adversary", pos: "noun", japanese: "敵、対戦相手", definition: "One's opponent in a contest, conflict, or dispute", example: "The grandmaster studied her adversary's previous tournament games thoroughly.", exampleJa: "グランドマスターは対戦相手の過去の試合を徹底的に研究した。" },
      { word: "homogenization", pos: "noun", japanese: "均質化、画一化", definition: "The process of making things uniform or similar", example: "Critics lament the homogenization of urban landscapes by global chains.", exampleJa: "批評家はグローバルチェーンによる都市景観の均質化を嘆く。" },
      { word: "convergent", pos: "adjective", japanese: "収束的な、一致する", definition: "Coming closer together or developing similar characteristics", example: "Convergent conclusions from three independent teams provided compelling evidence.", exampleJa: "3つの独立チームの収束的な結論が説得力ある証拠を提供した。" },
      { word: "intangible", pos: "adjective", japanese: "無形の、数値化しにくい", definition: "Unable to be touched or grasped; not having physical presence; difficult to define or measure", example: "Intangible benefits of strong culture often outweigh tangible assets.", exampleJa: "強い文化の無形の利益はしばしば有形資産を上回る。" },
      { word: "composure", pos: "noun", japanese: "冷静さ、落ち着き", definition: "The state of being calm and in control of oneself", example: "The surgeon's composure during the emergency saved the patient's life.", exampleJa: "緊急手術中の外科医の冷静さが患者の命を救った。" },
      { word: "astute", pos: "adjective", japanese: "鋭い、洞察力のある", definition: "Having or showing an ability to accurately assess situations and turn them to one's advantage", example: "The astute negotiator saw through the opponent's tactical maneuver.", exampleJa: "洞察力ある交渉者が相手の戦術的策略を見抜いた。" },
      { word: "supplant", pos: "verb", japanese: "取って代わる", definition: "To supersede and replace", example: "Streaming services have largely supplanted physical media formats.", exampleJa: "ストリーミングサービスが物理メディアにほぼ取って代わった。" }
    ],
...
The siege also showcased transformative military technology. Mehmed's enormous bronze cannons demonstrated that gunpowder artillery had rendered medieval fortifications obsolete, precipitating a revolution in military architecture.`,
    glossary: [
      { word: "siege", pos: "noun", japanese: "包囲攻撃", definition: "A military operation in which enemy forces surround a town or building, cutting off essential supplies", example: "The siege lasted three months before the garrison surrendered.", exampleJa: "包囲攻撃は3か月続き、その後守備隊は降伏した。" },
      { word: "breached", pos: "verb", japanese: "突破した、破った", definition: "Made a gap in and broke through a wall, barrier, or defense", example: "Hackers breached the company's firewall, compromising user data.", exampleJa: "ハッカーが会社のファイアウォールを突破し、ユーザーデータが流出した。" },
      { word: "extinguishing", pos: "verb", japanese: "消滅させる、終わらせる", definition: "Causing something to cease to burn or exist; putting an end to", example: "The regime succeeded in extinguishing all political opposition.", exampleJa: "政権はあらゆる政治的反対勢力を消滅させることに成功した。" },
      { word: "reverberated", pos: "verb", japanese: "反響した、影響を及ぼし続けた", definition: "Had continuing and serious effects; echoed repeatedly", example: "The rate hike reverberated through global financial markets.", exampleJa: "利上げは世界の金融市場に反響した。" },
      { word: "exodus", pos: "noun", japanese: "大量脱出、大移動", definition: "A mass departure of people", example: "The pandemic triggered an exodus from major urban centers.", exampleJa: "パンデミックが大都市からの大量脱出を引き起こした。" },
      { word: "pedagogical", pos: "adjective", japanese: "教育学的な", definition: "Relating to the methods and practice of teaching", example: "The university introduced several pedagogical innovations last year.", exampleJa: "大学は昨年いくつかの教育学的イノベーションを導入した。" },
      { word: "ferment", pos: "noun", japanese: "興奮、動乱、発酵", definition: "A state of agitation or turbulent change; widespread excitement", example: "Political ferment swept the region after the disputed election.", exampleJa: "紛糾した選挙の後、政治的動乱が地域に広がった。" },
      { word: "humanistic", pos: "adjective", japanese: "人文主義的な", definition: "Relating to a system of thought emphasizing human values, reason, and the study of classical texts", example: "Renaissance humanistic tradition emphasized studying classical literature.", exampleJa: "ルネサンスの人文主義的伝統は古典文学の研究を重視した。" },
      { word: "lucrative", pos: "adjective", japanese: "利益の多い、儲かる", definition: "Producing a great deal of profit", example: "Rare disease treatments proved surprisingly lucrative for the company.", exampleJa: "希少疾患の治療は会社にとって驚くほど儲かった。" },
      { word: "inaugurate", pos: "verb", japanese: "開始する、就任させる", definition: "To begin or introduce a system, policy, or period; to formally admit to office", example: "The railroad inaugurated a new era of westward expansion.", exampleJa: "鉄道が西方への拡大の新時代を開始した。" },
      { word: "apocalyptic", pos: "adjective", japanese: "黙示録的な、世界終末的な", definition: "Describing or prophesying the complete destruction of the world; extremely catastrophic", example: "The wildfire's scale prompted apocalyptic comparisons from responders.", exampleJa: "山火事の規模は救急隊員から黙示録的な比較を引き出した。" },
      { word: "spurring", pos: "verb", japanese: "促す、拍車をかける", definition: "Encouraging or stimulating action; giving an incentive", example: "Tax incentives succeeded in spurring renewable energy investment.", exampleJa: "税制優遇措置が再生可能エネルギーへの投資を促した。" },
      { word: "obsolete", pos: "adjective", japanese: "時代遅れの、廃れた", definition: "No longer produced or used; out of date", example: "Smartphone cameras have rendered point-and-shoot models virtually obsolete.", exampleJa: "スマホカメラがコンパクトカメラを事実上時代遅れにした。" },
      { word: "precipitating", pos: "verb", japanese: "引き起こす、促進する", definition: "Causing something to happen suddenly or prematurely", example: "The bank's collapse ended up precipitating a broader crisis.", exampleJa: "銀行の破綻がより広範な危機を引き起こした。" }
    ],
...
However, researchers caution against premature enthusiasm. The replication crisis has afflicted microbiome studies, and establishing causal relationships requires larger longitudinal investigations.`,
    glossary: [
      { word: "bidirectional", pos: "adjective", japanese: "双方向の", definition: "Functioning in or allowing movement in two opposite directions", example: "The highway features bidirectional traffic flow on all lanes.", exampleJa: "その高速道路は全車線で双方向の交通を特徴とする。" },
      { word: "gastrointestinal", pos: "adjective", japanese: "胃腸の、消化管の", definition: "Relating to the stomach and the intestines", example: "Chronic gastrointestinal disorders affect millions of Americans annually.", exampleJa: "慢性の胃腸障害は毎年何百万人ものアメリカ人に影響を及ぼす。" },
      { word: "therapeutic", pos: "adjective", japanese: "治療的な、治療上の", definition: "Relating to the healing of disease; having a beneficial effect on health", example: "CRISPR's therapeutic potential has excited the medical community.", exampleJa: "CRISPRの治療上の可能性が医学界を興奮させている。" },
      { word: "neurotransmitters", pos: "noun", japanese: "神経伝達物質", definition: "Chemical messengers that transmit signals between nerve cells", example: "Antidepressants work by altering neurotransmitter concentrations in the brain.", exampleJa: "抗うつ薬は脳内の神経伝達物質の濃度を変化させて作用する。" },
      { word: "inflammatory mediators", pos: "noun phrase", japanese: "炎症メディエーター", definition: "Substances released by cells that trigger or regulate the inflammatory response", example: "Elevated inflammatory mediators were linked to cognitive decline.", exampleJa: "炎症メディエーターの上昇は認知機能低下と関連していた。" },
      { word: "synthesis", pos: "noun", japanese: "合成、統合", definition: "The combination of components to form a connected whole; the production of chemical compounds", example: "Patent restrictions hampered antimalarial drug synthesis in developing countries.", exampleJa: "特許制限が発展途上国での抗マラリア薬の合成を阻害した。" },
      { word: "randomized controlled", pos: "adjective phrase", japanese: "無作為化対照（の）", definition: "Relating to a scientific experiment in which participants are randomly assigned to treatment or control groups", example: "The randomized controlled trial involved fifteen thousand participants.", exampleJa: "その無作為化対照試験は1万5千人の参加者を含んでいた。" },
      { word: "cortisol", pos: "noun", japanese: "コルチゾール（ストレスホルモン）", definition: "A steroid hormone produced by the adrenal glands in response to stress", example: "Chronic stress elevates cortisol, harming long-term health.", exampleJa: "慢性的なストレスはコルチゾールを上昇させ、長期的な健康を損なう。" },
      { word: "psychobiotics", pos: "noun", japanese: "サイコバイオティクス", definition: "Probiotics that confer mental health benefits through interaction with the gut-brain axis", example: "Psychobiotics have attracted significant pharmaceutical investment recently.", exampleJa: "サイコバイオティクスは最近大きな製薬投資を引き付けている。" },
      { word: "vagus nerve", pos: "noun", japanese: "迷走神経", definition: "The longest cranial nerve, running from the brainstem to the abdomen, regulating many bodily functions", example: "Vagus nerve stimulation is a promising epilepsy treatment.", exampleJa: "迷走神経刺激はてんかんの有望な治療法である。" },
      { word: "conduit", pos: "noun", japanese: "導管、伝達経路", definition: "A channel for conveying something, such as water, electrical wires, or information", example: "The embassy served as a conduit for backchannel communications.", exampleJa: "大使館が裏チャンネルのコミュニケーションの伝達経路として機能した。" },
      { word: "modulate", pos: "verb", japanese: "調節する、変調する", definition: "To adjust or regulate the degree, intensity, or quality of something", example: "The drug modulates immune response rather than suppressing it.", exampleJa: "その薬は免疫反応を抑制するのではなく調節する。" },
      { word: "replication crisis", pos: "noun phrase", japanese: "再現性の危機", definition: "The ongoing methodological crisis in which many scientific study results are difficult or impossible to reproduce", example: "The replication crisis prompted journals to adopt pre-registration requirements.", exampleJa: "再現性の危機が学術誌に事前登録要件の採用を促した。" },
      { word: "longitudinal", pos: "adjective", japanese: "縦断的な、長期的な", definition: "Involving the repeated observation of the same subjects over a period of time", example: "The longitudinal study tracked nurses' health over thirty years.", exampleJa: "その縦断的研究は看護師の健康を30年間追跡した。" }
    ],
...
Hargrove noticed a barely perceptible scuff mark near the bookcase. She pressed methodically along the shelves until she heard a faint mechanical click.`,
    glossary: [
      { word: "disheveled", pos: "adjective", japanese: "乱れた、散らかった", definition: "Untidy in appearance; disordered", example: "He arrived at the interview looking disheveled and exhausted.", exampleJa: "彼は面接に乱れた疲れ切った様子で到着した。" },
      { word: "meticulous", pos: "adjective", japanese: "細心の注意を払う、几帳面な", definition: "Showing great attention to detail; very careful and precise", example: "Her meticulous audit uncovered a sophisticated embezzlement scheme.", exampleJa: "彼女の細心の監査が巧妙な横領スキームを発見した。" },
      { word: "instilled", pos: "verb", japanese: "教え込んだ、植え付けた", definition: "Gradually but firmly established an idea or attitude in a person's mind", example: "Military training instilled discipline that lasted a lifetime.", exampleJa: "軍事訓練が生涯続く規律を植え付けた。" },
      { word: "invariable", pos: "adjective", japanese: "不変の、変わらない", definition: "Never changing; always the same", example: "His invariable morning routine continued for over thirty years.", exampleJa: "彼の不変の朝の日課は30年以上続いた。" },
      { word: "charred", pos: "adjective", japanese: "焦げた、炭化した", definition: "Partially burned so as to be blackened", example: "Investigators recovered charred document fragments from the fireplace.", exampleJa: "捜査官が暖炉から焦げた書類の断片を回収した。" },
      { word: "remnants", pos: "noun", japanese: "残骸、残り", definition: "Small remaining quantities of something; things left behind", example: "Archaeologists discovered remnants of an ancient fortification wall.", exampleJa: "考古学者が古代の城壁の残骸を発見した。" },
      { word: "beneficiary", pos: "noun", japanese: "受益者、恩恵を受ける人", definition: "A person who derives advantage from something, especially a trust, will, or insurance policy", example: "The insurance beneficiary was changed just before his death.", exampleJa: "保険の受益者が彼の死の直前に変更されていた。" },
      { word: "deceased", pos: "adjective/noun", japanese: "故人の、死亡した", definition: "No longer living; a dead person", example: "The deceased left contradictory instructions in two separate wills.", exampleJa: "故人は二つの別々の遺言書に矛盾する指示を残した。" },
      { word: "nagged", pos: "verb", japanese: "気になり続けた、しつこく悩ませた", definition: "Caused persistent discomfort or anxiety; worried continuously", example: "A vague unease nagged at her throughout the presentation.", exampleJa: "漠然とした不安がプレゼン中ずっと彼女を悩ませた。" },
      { word: "incinerated", pos: "verb", japanese: "焼却された", definition: "Destroyed completely by burning", example: "Classified documents were incinerated under strict security supervision.", exampleJa: "機密文書が厳重な警備の下で焼却された。" },
      { word: "contentedly", pos: "adverb", japanese: "満足そうに、安らかに", definition: "In a happy and satisfied manner", example: "The retired executive spent mornings contentedly tending her garden.", exampleJa: "退職した幹部は朝を満足そうに庭の手入れに費やした。" },
      { word: "sedated", pos: "verb/adjective", japanese: "鎮静剤を投与された", definition: "Put under the influence of a sedative drug; made calm or sleepy", example: "The veterinarian sedated the injured animal before examination.", exampleJa: "獣医は検査前に負傷した動物を鎮静させた。" },
      { word: "perceptible", pos: "adjective", japanese: "知覚できる、わずかに見える", definition: "Able to be seen, heard, or noticed, especially barely", example: "A barely perceptible tremor betrayed the witness's nervousness.", exampleJa: "かろうじて知覚できる震えが証人の緊張を裏切った。" },
      { word: "methodically", pos: "adverb", japanese: "系統的に、几帳面に", definition: "In a systematic, orderly, or organized way", example: "The team methodically tested each variable in isolation.", exampleJa: "チームは各変数を個別に系統的にテストした。" }
    ],
...
Perhaps the most productive framework acknowledges food as simultaneously sustenance, art, commerce, and cultural expression—requiring ongoing dialogue rather than rigid prescriptions.`,
    glossary: [
      { word: "culinary", pos: "adjective", japanese: "料理の、食の", definition: "Relating to cooking or the kitchen", example: "Southern France's culinary traditions span many centuries.", exampleJa: "南フランスの料理の伝統は何世紀にもわたる。" },
      { word: "fusion", pos: "noun", japanese: "フュージョン、融合", definition: "The process of combining two or more distinct elements into a unified whole", example: "The restaurant's fusion of Japanese and Scandinavian cuisine earned acclaim.", exampleJa: "レストランの日本とスカンジナビア料理の融合が称賛を得た。" },
      { word: "gastronomic", pos: "adjective", japanese: "美食の、食道楽の", definition: "Relating to the art or science of good eating; culinary", example: "The annual gastronomic festival attracts thousands of visitors.", exampleJa: "毎年の美食フェスティバルが何千人もの来場者を引き付ける。" },
      { word: "appropriation", pos: "noun", japanese: "文化の盗用、流用", definition: "The unacknowledged or inappropriate adoption of customs, practices, or ideas of one group by another", example: "The designer faced accusations of cultural appropriation.", exampleJa: "そのデザイナーは文化の盗用の非難に直面した。" },
      { word: "palate", pos: "noun", japanese: "味覚、嗜好", definition: "A person's appreciation of taste and flavor; the sense of taste", example: "Traveling through Asia gradually expanded her palate.", exampleJa: "アジアを旅して彼女の味覚は徐々に広がった。" },
      { word: "repertoire", pos: "noun", japanese: "レパートリー、持ちネタ", definition: "The range of skills, techniques, or items that a person or group regularly uses", example: "The diplomat's repertoire of negotiation strategies proved invaluable.", exampleJa: "外交官の交渉戦略のレパートリーが非常に貴重だった。" },
      { word: "commodification", pos: "noun", japanese: "商品化", definition: "The transformation of something into a commodity that can be bought and sold", example: "The commodification of education has transformed universities into businesses.", exampleJa: "教育の商品化が大学をビジネスへと変容させた。" },
      { word: "foodways", pos: "noun", japanese: "食文化、食習慣", definition: "The eating habits and culinary practices of a people, region, or historical period", example: "The anthropologist documented the community's traditional foodways.", exampleJa: "人類学者がそのコミュニティの伝統的な食文化を記録した。" },
      { word: "irrevocably", pos: "adverb", japanese: "取り返しのつかないほど、不可逆的に", definition: "In a way that cannot be changed, reversed, or recovered", example: "The oil spill irrevocably damaged the coastal ecosystem.", exampleJa: "石油流出が沿岸の生態系を取り返しのつかないほど損傷した。" },
      { word: "intermediaries", pos: "noun", japanese: "仲介者、仲介業者", definition: "People or organizations that act as links between parties to facilitate transactions", example: "Blockchain eliminates the need for financial intermediaries.", exampleJa: "ブロックチェーンが金融仲介業者の必要性を排除する。" },
      { word: "contentious", pos: "adjective", japanese: "論争を呼ぶ、議論の多い", definition: "Causing or likely to cause disagreement or argument", example: "Immigration policy remains a deeply contentious political issue.", exampleJa: "移民政策は依然として深く論争を呼ぶ政治的問題である。" },
      { word: "legitimacy", pos: "noun", japanese: "正当性、合法性", definition: "Conformity to the law, rules, or standards; the quality of being legitimate", example: "The new government struggled to establish its legitimacy.", exampleJa: "新政府は正当性の確立に苦労した。" },
      { word: "sustenance", pos: "noun", japanese: "食物、栄養、生計の糧", definition: "Food and drink regarded as a source of strength; nourishment", example: "Indigenous communities relied on salmon as primary sustenance.", exampleJa: "先住民コミュニティはサケを主要な食物として頼った。" },
      { word: "prescriptions", pos: "noun", japanese: "処方、規範、指示", definition: "Authoritative recommendations or rules about what should be done", example: "International lending institutions' policy prescriptions drew criticism.", exampleJa: "国際融資機関の政策規範が批判を浴びた。" }
    ],
...
ESSAYS.push(
{
  ...
  glossary: [
    { word: "bounce", pos: "verb", japanese: "立ち去る、辞める", definition: "to leave a place or quit a job informally", example: "I'm gonna bounce after this shift.", exampleJa: "このシフトが終わったら帰るよ。" },
    { word: "dip", pos: "verb", japanese: "こっそり去る", definition: "to leave quickly or without telling anyone", example: "He dipped before the boss noticed.", exampleJa: "上司が気づく前に抜け出した。" },
    { word: "peace out", pos: "phrase", japanese: "じゃあね、バイバイ", definition: "a casual way to say goodbye when leaving", example: "Alright everyone, I'm gonna peace out.", exampleJa: "みんな、じゃあ帰るわ。" },
    { word: "call it quits", pos: "phrase", japanese: "やめにする、見切りをつける", definition: "to decide to stop doing something permanently", example: "She called it quits after the argument.", exampleJa: "口論の後、彼女はやめることにした。" },
    { word: "resign", pos: "verb", japanese: "辞任する", definition: "to formally give up a position or job", example: "He resigned from his post last Friday.", exampleJa: "彼は先週金曜に辞任した。" },
    { word: "put in my two weeks", pos: "phrase", japanese: "2週間前の退職届を出す", definition: "to formally notify your employer you will leave in two weeks", example: "I just put in my two weeks today.", exampleJa: "今日、2週間前通知を出したよ。" },
    { word: "rage quit", pos: "verb", japanese: "怒って辞める、キレて辞める", definition: "to quit suddenly out of frustration or anger", example: "He rage quit after the terrible review.", exampleJa: "ひどい評価の後、キレて辞めた。" },
    { word: "departure", pos: "noun", japanese: "出発、退職", definition: "the act of leaving a place or a job", example: "Her departure surprised the whole team.", exampleJa: "彼女の退職はチーム全体を驚かせた。" },
    { word: "deal with", pos: "phrasal verb", japanese: "対処する、我慢する", definition: "to handle or cope with a difficult situation", example: "I can't deal with this stress anymore.", exampleJa: "もうこのストレスには耐えられない。" },
    { word: "had enough", pos: "phrase", japanese: "もうたくさん、限界だ", definition: "reached the point of no longer tolerating something", example: "I've had enough of these late nights.", exampleJa: "こんな夜遅くまでの仕事はもうたくさんだ。" },
    { word: "capture", pos: "verb", japanese: "捉える、表現する", definition: "to successfully represent or express a feeling", example: "The song captures the mood of summer.", exampleJa: "その曲は夏の気分をうまく表現している。" }
  ],
...
},
{
  ...
  glossary: [
    { word: "fire", pos: "adjective", japanese: "最高の、イケてる", definition: "extremely good, cool, or impressive", example: "Your new shoes are straight fire.", exampleJa: "君の新しい靴マジで最高だね。" },
    { word: "bussin", pos: "adjective", japanese: "めちゃくちゃ美味い・すごい", definition: "extremely good, especially used for food", example: "This burger is bussin, no cap.", exampleJa: "このバーガー、マジでやばい。" },
    { word: "slaps", pos: "verb", japanese: "最高だ（音楽・食べ物など）", definition: "to be excellent or highly enjoyable", example: "That new album really slaps hard.", exampleJa: "あのニューアルバム本当に最高だ。" },
    { word: "hits different", pos: "phrase", japanese: "格別に感じる、特別だ", definition: "feels uniquely good or emotionally impactful", example: "Homemade soup in winter hits different.", exampleJa: "冬の手作りスープは格別だ。" },
    { word: "go-to", pos: "adjective", japanese: "定番の、頼りになる", definition: "preferred or most commonly used", example: "Pizza is my go-to comfort food.", exampleJa: "ピザは私の定番の癒やし料理だ。" },
    { word: "top-notch", pos: "adjective", japanese: "一流の、最高品質の", definition: "of the highest quality or standard", example: "The service at that hotel is top-notch.", exampleJa: "あのホテルのサービスは一流だ。" },
    { word: "vernacular", pos: "noun", japanese: "日常語、方言", definition: "the language or dialect spoken by ordinary people", example: "Southern vernacular includes many unique phrases.", exampleJa: "南部の方言には独特の表現が多い。" },
    { word: "mainstream", pos: "adjective", japanese: "主流の", definition: "accepted by or available to most people", example: "The trend has gone completely mainstream now.", exampleJa: "そのトレンドは今や完全に主流だ。" },
    { word: "convey", pos: "verb", japanese: "伝える、表現する", definition: "to communicate or express a feeling or idea", example: "His smile conveyed pure happiness.", exampleJa: "彼の笑顔は純粋な幸せを伝えていた。" },
    { word: "enthusiasm", pos: "noun", japanese: "熱意、熱狂", definition: "intense enjoyment or eager interest in something", example: "She talked about the project with enthusiasm.", exampleJa: "彼女はそのプロジェクトについて熱意を持って話した。" },
    { word: "outfit", pos: "noun", japanese: "服装、コーディネート", definition: "a set of clothes worn together", example: "She picked out a cute outfit for tonight.", exampleJa: "彼女は今夜のためにかわいい服を選んだ。" }
  ],
...
},
{
  ...
  glossary: [
    { word: "talking stage", pos: "noun", japanese: "付き合う前のやり取り段階", definition: "the period of texting and flirting before officially dating", example: "We're just in the talking stage right now.", exampleJa: "今はまだやり取りしてるだけの段階だよ。" },
    { word: "situationship", pos: "noun", japanese: "曖昧な関係", definition: "a romantic relationship without clear labels or commitment", example: "Our situationship has lasted for six months.", exampleJa: "私たちの曖昧な関係は6ヶ月続いている。" },
    { word: "DTR", pos: "abbreviation", japanese: "関係を明確にする", definition: "define the relationship — having a talk about commitment", example: "I think it's time we DTR.", exampleJa: "そろそろ関係をはっきりさせる時だと思う。" },
    { word: "catching feelings", pos: "phrase", japanese: "好きになってしまう", definition: "starting to develop romantic emotions for someone", example: "I'm catching feelings for my best friend.", exampleJa: "親友のことを好きになりかけている。" },
    { word: "ghosting", pos: "noun", japanese: "突然音信不通にすること", definition: "suddenly cutting off all communication without explanation", example: "He ghosted me after three great dates.", exampleJa: "3回の素敵なデートの後、彼は音信不通になった。" },
    { word: "breadcrumbing", pos: "noun", japanese: "思わせぶりなメッセージを送ること", definition: "sending occasional messages to keep someone interested without commitment", example: "She's breadcrumbing you — don't fall for it.", exampleJa: "彼女は思わせぶりなだけだよ、騙されるな。" },
    { word: "gray area", pos: "noun", japanese: "曖昧な領域", definition: "a situation that is unclear or not well defined", example: "Our friendship exists in a gray area.", exampleJa: "私たちの友情は曖昧な領域にある。" },
    { word: "flirt", pos: "verb", japanese: "いちゃつく、口説く", definition: "to behave in a playful romantic way", example: "He was flirting with her all evening.", exampleJa: "彼は一晩中彼女にちょっかいを出していた。" },
    { word: "commitment", pos: "noun", japanese: "コミットメント、献身", definition: "a promise or dedication to a relationship or cause", example: "She's afraid of making any serious commitment.", exampleJa: "彼女は真剣な約束をすることを恐れている。" },
    { word: "casual", pos: "adjective", japanese: "気軽な、本気でない", definition: "relaxed and without serious intention", example: "They agreed to keep things casual for now.", exampleJa: "彼らはとりあえず気軽な関係でいることにした。" },
    { word: "navigate", pos: "verb", japanese: "うまく切り抜ける", definition: "to find one's way through a complicated situation", example: "It's hard to navigate office politics.", exampleJa: "社内政治をうまく切り抜けるのは難しい。" },
    { word: "label", pos: "noun", japanese: "ラベル、呼び名", definition: "a word or phrase used to classify a relationship", example: "We haven't put a label on it yet.", exampleJa: "まだ私たちの関係に名前をつけていない。" }
  ],
...
},
{
  ...
  glossary: [
    { word: "go viral", pos: "phrase", japanese: "バズる、拡散する", definition: "to spread rapidly across the internet", example: "Her dance video went viral last week.", exampleJa: "彼女のダンス動画が先週バズった。" },
    { word: "ratio'd", pos: "adjective", japanese: "批判的返信が多い状態", definition: "receiving more negative replies than likes on a post", example: "The politician got ratio'd for that tweet.", exampleJa: "その政治家はあのツイートで批判返信の嵐を受けた。" },
    { word: "clout", pos: "noun", japanese: "影響力、ネット上の人気", definition: "influence or popularity, especially on social media", example: "He does anything for clout these days.", exampleJa: "彼は最近、注目を集めるためなら何でもする。" },
    { word: "influencer", pos: "noun", japanese: "インフルエンサー", definition: "a person with a large online following who shapes opinions", example: "She became a fitness influencer on Instagram.", exampleJa: "彼女はインスタでフィットネスインフルエンサーになった。" },
    { word: "double-edged sword", pos: "noun", japanese: "諸刃の剣", definition: "something that has both positive and negative effects", example: "Social media fame is a double-edged sword.", exampleJa: "SNSでの有名さは諸刃の剣だ。" },
    { word: "controversial", pos: "adjective", japanese: "物議を醸す", definition: "causing disagreement or public debate", example: "His controversial remarks sparked a huge debate.", exampleJa: "彼の物議を醸す発言が大論争を引き起こした。" },
    { word: "glamorous", pos: "adjective", japanese: "華やかな", definition: "attractive and exciting in a special way", example: "The job sounds glamorous but it's exhausting.", exampleJa: "その仕事は華やかに聞こえるが疲れる。" },
    { word: "content creation", pos: "noun", japanese: "コンテンツ制作", definition: "the process of producing media for online platforms", example: "Content creation takes more effort than people think.", exampleJa: "コンテンツ制作は思っている以上に大変だ。" },
    { word: "algorithm", pos: "noun", japanese: "アルゴリズム（表示順決定の仕組み）", definition: "a set of rules a platform uses to decide what content to show", example: "The algorithm keeps showing me cat videos.", exampleJa: "アルゴリズムが猫の動画ばかり表示してくる。" },
    { word: "following", pos: "noun", japanese: "フォロワー数、支持者層", definition: "a group of people who follow someone online", example: "She has a massive following on TikTok.", exampleJa: "彼女はTikTokで大量のフォロワーがいる。" },
    { word: "public perception", pos: "noun", japanese: "世間の印象", definition: "the way the general public views someone or something", example: "Public perception of the brand has improved.", exampleJa: "そのブランドへの世間の印象は改善した。" }
  ],
...
},
{
  ...
  glossary: [
    { word: "salty", pos: "adjective", japanese: "イラついている、根に持っている", definition: "bitter or upset, especially about something small", example: "Don't be salty just because you lost.", exampleJa: "負けたからってイラつくなよ。" },
    { word: "pressed", pos: "adjective", japanese: "気にしすぎている、ムキになっている", definition: "overly bothered or concerned about something", example: "She seems really pressed about the situation.", exampleJa: "彼女はその状況にかなりムキになっているようだ。" },
    { word: "heated", pos: "adjective", japanese: "白熱した、激昂した", definition: "intensely angry or emotionally charged", example: "The discussion became heated very quickly.", exampleJa: "議論はあっという間に白熱した。" },
    { word: "triggered", pos: "adjective", japanese: "過剰反応する、カチンとくる", definition: "easily upset or provoked by a specific topic", example: "He gets triggered by any kind of criticism.", exampleJa: "彼はどんな批判にも過剰反応する。" },
    { word: "bitter", pos: "adjective", japanese: "恨みがましい、辛辣な", definition: "feeling resentful or angry about past events", example: "She's still bitter about the breakup.", exampleJa: "彼女はまだ別れを恨んでいる。" },
    { word: "intensify", pos: "verb", japanese: "激しくなる", definition: "to become stronger or more extreme", example: "The storm will intensify by tonight.", exampleJa: "嵐は今夜までに激しくなるだろう。" },
    { word: "overreaction", pos: "noun", japanese: "過剰反応", definition: "a response that is stronger than what the situation calls for", example: "Crying over spilled milk is an overreaction.", exampleJa: "こぼれた牛乳で泣くのは過剰反応だ。" },
    { word: "mocking", pos: "adjective", japanese: "嘲笑的な、からかう", definition: "making fun of someone in a mean way", example: "His mocking tone made everyone uncomfortable.", exampleJa: "彼の嘲笑的な口調でみんな不快になった。" },
    { word: "annoyance", pos: "noun", japanese: "苛立ち", definition: "a feeling of mild anger or irritation", example: "She couldn't hide her annoyance at the delay.", exampleJa: "遅延への苛立ちを隠せなかった。" },
    { word: "visibly", pos: "adverb", japanese: "目に見えて", definition: "in a way that can be clearly noticed", example: "He was visibly upset after hearing the news.", exampleJa: "そのニュースを聞いて彼は目に見えて動揺した。" }
  ],
...
},
{
  ...
  glossary: [
    { word: "mind-blown", pos: "adjective", japanese: "度肝を抜かれた", definition: "extremely surprised or amazed by new information", example: "The documentary left me completely mind-blown.", exampleJa: "そのドキュメンタリーには度肝を抜かれた。" },
    { word: "I can't even", pos: "phrase", japanese: "もう無理、言葉にできない", definition: "an expression of being so overwhelmed you cannot respond", example: "He proposed on live TV — I can't even.", exampleJa: "彼が生放送でプロポーズした — もう無理。" },
    { word: "dead", pos: "adjective", japanese: "（面白すぎ・衝撃で）死んだ", definition: "so amused or shocked that one cannot function", example: "That meme has me dead right now.", exampleJa: "あのミーム、面白すぎて死ぬ。" },
    { word: "shooketh", pos: "adjective", japanese: "超ショック、激しく動揺", definition: "a humorous intensified form of shocked or shaken", example: "I was shooketh when she quit her job.", exampleJa: "彼女が仕事を辞めた時、めちゃくちゃ動揺した。" },
    { word: "overwhelmed", pos: "adjective", japanese: "圧倒された", definition: "feeling too much emotion to handle", example: "She felt overwhelmed by all the attention.", exampleJa: "彼女は注目の多さに圧倒された。" },
    { word: "figuratively", pos: "adverb", japanese: "比喩的に", definition: "in a metaphorical sense, not literally", example: "I figuratively died of embarrassment on stage.", exampleJa: "ステージで比喩的に恥ずかしさで死んだ。" },
    { word: "exaggeration", pos: "noun", japanese: "誇張", definition: "making something sound bigger or more dramatic than it is", example: "Saying it was a disaster is an exaggeration.", exampleJa: "災害だったというのは誇張だ。" },
    { word: "earth-shattering", pos: "adjective", japanese: "衝撃的な、天地を揺るがす", definition: "extremely surprising or important", example: "The news was hardly earth-shattering to anyone.", exampleJa: "そのニュースは誰にとっても衝撃的とは言えなかった。" },
    { word: "plot twist", pos: "noun", japanese: "どんでん返し", definition: "an unexpected turn of events in a story", example: "The movie had an incredible plot twist.", exampleJa: "その映画にはすごいどんでん返しがあった。" },
    { word: "thrive on", pos: "phrasal verb", japanese: "〜で盛り上がる、〜を糧にする", definition: "to grow or succeed because of something", example: "She thrives on creative challenges at work.", exampleJa: "彼女は仕事の創造的な挑戦で力を発揮する。" }
  ],
...
},
{
  ...
  glossary: [
    { word: "bet", pos: "interjection", japanese: "了解、いいよ、オッケー", definition: "used to express agreement or confirmation", example: "You coming tonight? — Bet, see you there.", exampleJa: "今夜来る？ — 了解、現地で会おう。" },
    { word: "facts", pos: "interjection", japanese: "それな、まさにその通り", definition: "used to confirm that something is completely true", example: "That exam was brutal. — Facts.", exampleJa: "あの試験はえぐかった。 — それな。" },
    { word: "on God", pos: "phrase", japanese: "マジで、誓って", definition: "used to emphasize that you are being completely honest", example: "On God, I had nothing to do with it.", exampleJa: "マジで、俺は関係ない。" },
    { word: "say less", pos: "phrase", japanese: "もう十分、分かった", definition: "used to show you are already fully convinced", example: "Free food at the party? — Say less.", exampleJa: "パーティーで無料の食事？ — もう十分、行く。" },
    { word: "brevity", pos: "noun", japanese: "簡潔さ", definition: "the quality of expressing something in few words", example: "Brevity is the soul of wit.", exampleJa: "簡潔さは機知の本質である。" },
    { word: "punchy", pos: "adjective", japanese: "パンチの効いた、インパクトのある", definition: "short, forceful, and having a strong effect", example: "She gave a punchy presentation that impressed everyone.", exampleJa: "彼女はインパクトのあるプレゼンで全員を感心させた。" },
    { word: "confident", pos: "adjective", japanese: "自信のある", definition: "feeling sure about your own abilities or opinions", example: "He sounded confident about the plan.", exampleJa: "彼はその計画に自信がありそうだった。" },
    { word: "emphasis", pos: "noun", japanese: "強調", definition: "special importance or attention given to something", example: "She put emphasis on being punctual.", exampleJa: "彼女は時間厳守を強調した。" },
    { word: "convinced", pos: "adjective", japanese: "納得した、確信した", definition: "firmly believing something is true or right", example: "I'm convinced this is the best approach.", exampleJa: "これが最善の方法だと確信している。" },
    { word: "effortless", pos: "adjective", japanese: "楽な、苦労を感じさせない", definition: "requiring no physical or mental effort; appearing easy", example: "Her cooking looks effortless but takes skill.", exampleJa: "彼女の料理は簡単そうに見えるが技術が要る。" },
    { word: "trait", pos: "noun", japanese: "特徴", definition: "a distinguishing quality or characteristic", example: "Honesty is her most admirable trait.", exampleJa: "正直さは彼女の最も素晴らしい特徴だ。" }
  ],
...
},
{
  ...
  glossary: [
    { word: "hard pass", pos: "noun", japanese: "断固として断る、絶対お断り", definition: "a firm and absolute refusal", example: "Eating insects? That's a hard pass for me.", exampleJa: "虫を食べる？絶対にお断りだ。" },
    { word: "nah", pos: "interjection", japanese: "いや、ううん", definition: "an informal way of saying no", example: "Nah, I don't feel like going out tonight.", exampleJa: "いや、今夜は出かける気分じゃない。" },
    { word: "I'm good", pos: "phrase", japanese: "大丈夫です、結構です", definition: "a polite way to decline an offer", example: "Want some more coffee? — I'm good, thanks.", exampleJa: "コーヒーもう少しいかが？ — 大丈夫です、ありがとう。" },
    { word: "miss me with that", pos: "phrase", japanese: "それは勘弁して、やめてくれ", definition: "a dismissive way to reject something you find ridiculous", example: "Extra homework on Friday? Miss me with that.", exampleJa: "金曜に追加の宿題？勘弁してくれ。" },
    { word: "definitive", pos: "adjective", japanese: "最終的な、決定的な", definition: "done or reached in a way that cannot be changed", example: "The test results were definitive and clear.", exampleJa: "検査結果は決定的で明確だった。" },
    { word: "confrontational", pos: "adjective", japanese: "対立的な、けんか腰の", definition: "tending to deal with situations in an aggressive way", example: "His tone was unnecessarily confrontational.", exampleJa: "彼の口調は不必要にけんか腰だった。" },
    { word: "decline", pos: "verb", japanese: "断る、辞退する", definition: "to politely refuse an offer or invitation", example: "She declined the invitation to the party.", exampleJa: "彼女はパーティーの招待を断った。" },
    { word: "nonsense", pos: "noun", japanese: "ナンセンス、馬鹿げたこと", definition: "something that is silly, untrue, or has no meaning", example: "Stop talking nonsense and be serious.", exampleJa: "馬鹿なことを言うのはやめて真面目にして。" },
    { word: "decisive", pos: "adjective", japanese: "決断力のある、断固とした", definition: "able to make decisions quickly and with confidence", example: "A good leader must be decisive under pressure.", exampleJa: "良いリーダーはプレッシャー下でも決断力がなければならない。" },
    { word: "fluency", pos: "noun", japanese: "流暢さ", definition: "the ability to speak or write a language easily and accurately", example: "Her fluency in Japanese impressed everyone.", exampleJa: "彼女の日本語の流暢さはみんなを感心させた。" }
  ],
...
},
{
  ...
  glossary: [
    { word: "lag", pos: "noun/verb", japanese: "遅延、もたつく", definition: "a delay in response time, or to experience such a delay", example: "The video call keeps lagging during meetings.", exampleJa: "ビデオ通話がミーティング中にもたつき続ける。" },
    { word: "glitch", pos: "noun", japanese: "不具合、バグ", definition: "a small problem or error in a system", example: "There's a glitch in the payment system.", exampleJa: "決済システムに不具合がある。" },
    { word: "AFK", pos: "abbreviation", japanese: "離席中", definition: "away from keyboard — temporarily unavailable", example: "I'll be AFK for about ten minutes.", exampleJa: "10分ほど席を外します。" },
    { word: "rage quit", pos: "verb", japanese: "キレてやめる", definition: "to quit a game or activity in a fit of anger", example: "He rage quit after losing three times.", exampleJa: "3回負けた後、キレてやめた。" },
    { word: "nerf", pos: "verb", japanese: "弱体化する、性能を下げる", definition: "to weaken or reduce the power of something", example: "They nerfed my favorite character in the update.", exampleJa: "アップデートでお気に入りのキャラが弱体化された。" },
    { word: "GG", pos: "abbreviation", japanese: "お疲れ様、いい勝負だった", definition: "good game — said to acknowledge a fair competition", example: "GG, that was a really close match.", exampleJa: "お疲れ、本当に接戦だったね。" },
    { word: "malfunction", pos: "noun", japanese: "故障、誤作動", definition: "a failure to work correctly", example: "The machine had a serious malfunction yesterday.", exampleJa: "その機械は昨日深刻な故障を起こした。" },
    { word: "leak into", pos: "phrasal verb", japanese: "漏れ出す、浸透する", definition: "to gradually spread into another area", example: "Work stress often leaks into personal life.", exampleJa: "仕事のストレスは私生活に漏れ出すことが多い。" },
    { word: "acknowledge", pos: "verb", japanese: "認める、称える", definition: "to accept or recognize something", example: "She acknowledged her mistake and apologized.", exampleJa: "彼女は間違いを認めて謝罪した。" },
    { word: "mainstream", pos: "adjective", japanese: "主流の", definition: "considered normal and accepted by most people", example: "Gaming has become a mainstream hobby now.", exampleJa: "ゲームは今や主流の趣味になった。" }
  ],
...
},
{
  ...
  glossary: [
    { word: "pregame", pos: "verb", japanese: "飲み会前に飲む、0次会をする", definition: "to drink alcohol before going to the main event", example: "We always pregame before heading to the club.", exampleJa: "クラブに行く前にいつも0次会をする。" },
    { word: "turn up", pos: "phrasal verb", japanese: "盛り上がる、パーティーで騒ぐ", definition: "to arrive at a party or to party energetically", example: "Everyone's ready to turn up this weekend.", exampleJa: "今週末はみんな盛り上がる準備ができている。" },
    { word: "wasted", pos: "adjective", japanese: "べろべろに酔った", definition: "extremely drunk or intoxicated", example: "She got wasted at the office holiday party.", exampleJa: "彼女は会社の忘年会でべろべろに酔った。" },
    { word: "hair of the dog", pos: "phrase", japanese: "迎え酒", definition: "drinking alcohol to cure a hangover", example: "He swears by hair of the dog every Sunday.", exampleJa: "彼は毎週日曜に迎え酒が効くと信じている。" },
    { word: "hangover", pos: "noun", japanese: "二日酔い", definition: "the unpleasant effects felt after drinking too much alcohol", example: "I had a terrible hangover after the party.", exampleJa: "パーティーの後ひどい二日酔いだった。" },
    { word: "lightweight", pos: "noun", japanese: "酒に弱い人", definition: "a person who gets drunk quickly from small amounts of alcohol", example: "Two beers and he's done — total lightweight.", exampleJa: "ビール2杯で終わり — 完全に酒に弱い。" },
    { word: "blunt", pos: "adjective", japanese: "率直な、ぶっきらぼうな", definition: "direct and straightforward, sometimes rudely so", example: "She was blunt about her feelings on the matter.", exampleJa: "彼女はその件について率直だった。" },
    { word: "moderation", pos: "noun", japanese: "節度、適度", definition: "the practice of avoiding excess or extremes", example: "Enjoy your food and drink in moderation.", exampleJa: "食べ物と飲み物は節度を持って楽しもう。" },
    { word: "warm-up", pos: "noun", japanese: "準備、ウォーミングアップ", definition: "a preparatory activity before the main event", example: "The warm-up act was surprisingly entertaining.", exampleJa: "前座は驚くほど面白かった。" },
    { word: "decode", pos: "verb", japanese: "解読する、理解する", definition: "to understand the meaning of something unclear", example: "It took me a while to decode his message.", exampleJa: "彼のメッセージを理解するのに時間がかかった。" },
    { word: "nightlife", pos: "noun", japanese: "ナイトライフ、夜遊び", definition: "entertainment and social activities available at night", example: "Tokyo has an incredible nightlife scene.", exampleJa: "東京には素晴らしいナイトライフシーンがある。" }
  ],
...
},
{
  ...
  glossary: [
    { word: "nailed it", pos: "phrase", japanese: "完璧にやった、バッチリだった", definition: "did something perfectly or exactly right", example: "You nailed it — the client loved the pitch.", exampleJa: "バッチリだった — クライアントは提案を気に入った。" },
    { word: "crushed it", pos: "phrase", japanese: "圧倒的にうまくやった", definition: "performed extremely well, dominating a task", example: "She crushed it on the final exam.", exampleJa: "彼女は期末試験で圧倒的な成績だった。" },
    { word: "killing it", pos: "phrase", japanese: "絶好調だ、めちゃくちゃうまくやっている", definition: "performing exceptionally well over a period of time", example: "Your team has been killing it this quarter.", exampleJa: "君のチームは今四半期絶好調だ。" },
    { word: "on fire", pos: "phrase", japanese: "ノリに乗っている、絶好調だ", definition: "performing at an exceptionally high level", example: "The sales team is on fire this month.", exampleJa: "営業チームは今月ノリに乗っている。" },
    { word: "dominate", pos: "verb", japanese: "圧倒する、支配する", definition: "to control or be much better than others", example: "They dominated the competition from the start.", exampleJa: "彼らは最初から競争を圧倒した。" },
    { word: "sustained", pos: "adjective", japanese: "持続的な", definition: "continuing for a long period without interruption", example: "The company showed sustained growth for five years.", exampleJa: "その会社は5年間持続的な成長を見せた。" },
    { word: "imagery", pos: "noun", japanese: "イメージ、比喩表現", definition: "visually descriptive language or mental pictures", example: "The poem is full of vivid nature imagery.", exampleJa: "その詩は鮮やかな自然のイメージに満ちている。" },
    { word: "transform", pos: "verb", japanese: "変える、一変させる", definition: "to change something completely in form or character", example: "Technology has transformed how we communicate.", exampleJa: "テクノロジーはコミュニケーション方法を一変させた。" },
    { word: "enthusiastically", pos: "adverb", japanese: "熱狂的に", definition: "in a way that shows intense and eager enjoyment", example: "The crowd cheered enthusiastically for the team.", exampleJa: "群衆はチームに熱狂的に声援を送った。" },
    { word: "common thread", pos: "noun", japanese: "共通点", definition: "a theme or idea shared by several things", example: "Hard work is the common thread among successful people.", exampleJa: "努力は成功者たちの共通点だ。" }
  ],
...
},
{
  ...
  glossary: [
    { word: "blew it", pos: "phrase", japanese: "台無しにした、しくじった", definition: "ruined a chance or made a big mistake", example: "I blew it by arriving an hour late.", exampleJa: "1時間遅刻して台無しにした。" },
    { word: "choked", pos: "verb", japanese: "プレッシャーで失敗した", definition: "failed to perform well under pressure", example: "The team choked in the final round.", exampleJa: "チームは最終ラウンドでプレッシャーに負けた。" },
    { word: "tanked", pos: "verb", japanese: "大失敗した、大コケした", definition: "failed completely and dramatically", example: "The movie tanked at the box office.", exampleJa: "その映画は興行収入で大コケした。" },
    { word: "face-plant", pos: "noun/verb", japanese: "顔面から転ぶ、大恥をかく失敗", definition: "falling face-first, or an embarrassing failure", example: "My speech was a total face-plant yesterday.", exampleJa: "昨日のスピーチは完全な大失敗だった。" },
    { word: "crucial", pos: "adjective", japanese: "決定的な、極めて重要な", definition: "extremely important or decisive", example: "This is a crucial moment for the company.", exampleJa: "これは会社にとって決定的な瞬間だ。" },
    { word: "spectacularly", pos: "adverb", japanese: "派手に、壮絶に", definition: "in a dramatic and impressive way, often negatively", example: "The plan failed spectacularly on day one.", exampleJa: "その計画は初日から派手に失敗した。" },
    { word: "metaphorically", pos: "adverb", japanese: "比喩的に", definition: "in a way that uses one thing to represent another", example: "She metaphorically burned bridges with everyone.", exampleJa: "彼女は比喩的に皆との関係を断ち切った。" },
    { word: "cinematic", pos: "adjective", japanese: "映画のような", definition: "resembling or relating to movies", example: "The sunset was absolutely cinematic tonight.", exampleJa: "今夜の夕焼けはまるで映画のようだった。" },
    { word: "cope", pos: "verb", japanese: "対処する、乗り越える", definition: "to deal with a difficult situation successfully", example: "She coped with the loss by staying busy.", exampleJa: "彼女は忙しくすることで喪失に対処した。" },
    { word: "vivid", pos: "adjective", japanese: "生き生きとした、鮮やかな", definition: "producing strong, clear images in the mind", example: "He gave a vivid description of the accident.", exampleJa: "彼は事故について鮮やかな描写をした。" }
  ],
...
},
{
  ...
  glossary: [
    { word: "thrifty", pos: "adjective", japanese: "倹約上手な", definition: "careful and wise with money, avoiding waste", example: "She's thrifty but never sacrifices quality.", exampleJa: "彼女は倹約家だが品質は決して犠牲にしない。" },
    { word: "penny-pinching", pos: "adjective", japanese: "ケチな、細かくお金を惜しむ", definition: "excessively careful about spending even small amounts", example: "His penny-pinching habits annoy his friends.", exampleJa: "彼のケチな習慣は友人をイライラさせる。" },
    { word: "score a deal", pos: "phrase", japanese: "お得な買い物をする", definition: "to find and get an exceptionally good bargain", example: "We scored a deal on hotel rooms downtown.", exampleJa: "ダウンタウンのホテルでお得な取引をゲットした。" },
    { word: "freebie", pos: "noun", japanese: "無料のもの、おまけ", definition: "something given for free, usually as a promotion", example: "The café gave us freebies on opening day.", exampleJa: "そのカフェはオープン日に無料サービスをくれた。" },
    { word: "frugal", pos: "adjective", japanese: "質素な、節約的な", definition: "sparing or economical with regard to money", example: "Living a frugal lifestyle helped him retire early.", exampleJa: "質素な生活のおかげで早期退職できた。" },
    { word: "bargain", pos: "noun", japanese: "掘り出し物、お買い得", definition: "something bought for less than the usual price", example: "That jacket was a real bargain at half price.", exampleJa: "あのジャケットは半額で本当にお買い得だった。" },
    { word: "bang for your buck", pos: "phrase", japanese: "コスパが良い、お値打ち", definition: "good value in return for the money spent", example: "This restaurant gives you great bang for your buck.", exampleJa: "このレストランはコスパが最高だ。" },
    { word: "budget-friendly", pos: "adjective", japanese: "予算に優しい、手頃な", definition: "affordable and not too expensive", example: "We found a budget-friendly vacation package.", exampleJa: "手頃な旅行パッケージを見つけた。" },
    { word: "trade show", pos: "noun", japanese: "展示会、見本市", definition: "an exhibition where companies display their products", example: "We attended the tech trade show in Las Vegas.", exampleJa: "ラスベガスのテック展示会に参加した。" },
    { word: "judgmental", pos: "adjective", japanese: "批判的な、人を裁く", definition: "having a tendency to criticize others", example: "Try not to be judgmental about her choices.", exampleJa: "彼女の選択について批判的にならないようにしよう。" }
  ],
...
},
{
  ...
  glossary: [
    { word: "jelly", pos: "adjective", japanese: "うらやましい（jealousの略）", definition: "informal shortening of jealous", example: "You're going to Hawaii? I'm so jelly!", exampleJa: "ハワイに行くの？超うらやましい！" },
    { word: "green with envy", pos: "phrase", japanese: "嫉妬で緑になる、ひどく嫉妬する", definition: "extremely jealous of someone", example: "She was green with envy over the new house.", exampleJa: "新しい家をひどく嫉妬していた。" },
    { word: "FOMO", pos: "noun", japanese: "取り残される恐怖", definition: "fear of missing out — anxiety about missing exciting events", example: "Seeing their party photos gave me serious FOMO.", exampleJa: "彼らのパーティー写真を見て本気で取り残される恐怖を感じた。" },
    { word: "flex on", pos: "phrasal verb", japanese: "見せびらかす、自慢する", definition: "to show off wealth or success to make others envious", example: "She's always flexing on Instagram with designer bags.", exampleJa: "彼女はいつもインスタでブランドバッグを見せびらかしている。" },
    { word: "relatable", pos: "adjective", japanese: "共感できる", definition: "easy to understand or identify with", example: "Her struggles are very relatable to most people.", exampleJa: "彼女の苦労はほとんどの人にとって共感できる。" },
    { word: "amplify", pos: "verb", japanese: "増幅する、拡大する", definition: "to make something stronger or more noticeable", example: "Social media amplifies both positive and negative voices.", exampleJa: "SNSはポジティブもネガティブも増幅させる。" },
    { word: "comparison", pos: "noun", japanese: "比較", definition: "the act of evaluating similarities and differences", example: "Comparison with others leads to unhappiness.", exampleJa: "他人との比較は不幸につながる。" },
    { word: "inevitable", pos: "adjective", japanese: "避けられない", definition: "certain to happen and impossible to prevent", example: "Change is inevitable in any growing company.", exampleJa: "成長する会社では変化は避けられない。" },
    { word: "undercurrent", pos: "noun", japanese: "底流、潜在的な感情", definition: "a hidden feeling or tendency beneath the surface", example: "There was an undercurrent of tension in the room.", exampleJa: "部屋には緊張の底流があった。" },
    { word: "show off", pos: "phrasal verb", japanese: "見せびらかす", definition: "to display something proudly to impress others", example: "He loves to show off his cooking skills.", exampleJa: "彼は料理の腕前を見せびらかすのが好きだ。" },
    { word: "scrolling", pos: "verb", japanese: "スクロールする", definition: "moving through content on a screen by swiping or using a mouse", example: "I spent an hour scrolling through my feed.", exampleJa: "フィードをスクロールして1時間過ごした。" }
  ],
...
},
{
  ...
  glossary: [
    { word: "DL / down low", pos: "noun/phrase", japanese: "内緒で、秘密裏に", definition: "a state of secrecy or privacy", example: "Keep this on the DL until we're ready.", exampleJa: "準備ができるまでこれは内緒にして。" },
    { word: "hush-hush", pos: "adjective", japanese: "極秘の、内緒の", definition: "highly secret and not to be discussed publicly", example: "The project is totally hush-hush right now.", exampleJa: "そのプロジェクトは今のところ完全に極秘だ。" },
    { word: "keep it under wraps", pos: "phrase", japanese: "秘密にしておく、伏せておく", definition: "to keep something hidden or secret until the right time", example: "They kept the surprise party under wraps.", exampleJa: "彼らはサプライズパーティーを秘密にしていた。" },
    { word: "off the record", pos: "phrase", japanese: "オフレコで、非公式に", definition: "information shared privately, not for public disclosure", example: "Off the record, the deal might fall through.", exampleJa: "オフレコだけど、その取引はダメになるかもしれない。" },
    { word: "between you and me", pos: "phrase", japanese: "ここだけの話", definition: "a signal that what follows is confidential", example: "Between you and me, he's looking for another job.", exampleJa: "ここだけの話、彼は別の仕事を探している。" },
    { word: "merger", pos: "noun", japanese: "合併", definition: "the combining of two companies into one", example: "The merger was announced in a press conference.", exampleJa: "合併は記者会見で発表された。" },
    { word: "discretion", pos: "noun", japanese: "慎重さ、思慮深さ", definition: "the quality of being careful about what you say or do", example: "This matter requires the utmost discretion.", exampleJa: "この件は最大限の慎重さが必要だ。" },
    { word: "confidential", pos: "adjective", japanese: "機密の、秘密の", definition: "meant to be kept secret and not shared with others", example: "The document is marked as confidential.", exampleJa: "その書類は機密扱いになっている。" },
    { word: "boundary", pos: "noun", japanese: "境界、限界", definition: "a line or limit that defines the extent of something", example: "Setting boundaries at work is important.", exampleJa: "職場で境界を設けることは重要だ。" },
    { word: "sensitive", pos: "adjective", japanese: "機微な、デリケートな", definition: "requiring careful handling due to its private nature", example: "This is sensitive information — handle with care.", exampleJa: "これはデリケートな情報だ — 慎重に扱って。" },
    { word: "launch event", pos: "noun", japanese: "発表イベント、ローンチイベント", definition: "an event organized to introduce a new product or service", example: "The launch event attracted over five hundred people.", exampleJa: "発表イベントには500人以上が集まった。" }
  ],
...
},
{
  ...
  glossary: [
    { word: "slack off", pos: "phrasal verb", japanese: "サボる、手を抜く", definition: "to be lazy and avoid doing your work", example: "Don't slack off just because the boss is away.", exampleJa: "上司がいないからってサボるなよ。" },
    { word: "couch potato", pos: "noun", japanese: "ソファでゴロゴロする人", definition: "a lazy person who watches too much TV", example: "I've been a couch potato all weekend.", exampleJa: "週末ずっとソファでゴロゴロしていた。" },
    { word: "bum around", pos: "phrasal verb", japanese: "ブラブラする、何もせず過ごす", definition: "to spend time doing nothing productive", example: "We bummed around town with no real plan.", exampleJa: "特に予定もなく街をブラブラした。" },
    { word: "phoning it in", pos: "phrase", japanese: "やる気なく最低限だけやる", definition: "doing the minimum effort without real engagement", example: "He's been phoning it in at work lately.", exampleJa: "彼は最近仕事でやる気なく最低限しかやっていない。" },
    { word: "bare minimum", pos: "noun", japanese: "最低限", definition: "the least amount of effort or work required", example: "She only does the bare minimum to pass.", exampleJa: "彼女は合格するための最低限しかやらない。" },
    { word: "aimlessly", pos: "adverb", japanese: "あてもなく", definition: "without purpose or direction", example: "He wandered aimlessly through the streets.", exampleJa: "彼はあてもなく通りを歩き回った。" },
    { word: "productive", pos: "adjective", japanese: "生産的な", definition: "achieving or producing a significant amount", example: "I had a very productive morning at work.", exampleJa: "今朝は仕事がとても生産的だった。" },
    { word: "self-deprecating", pos: "adjective", japanese: "自虐的な", definition: "making fun of oneself in a modest or humorous way", example: "His self-deprecating humor makes everyone laugh.", exampleJa: "彼の自虐的なユーモアは皆を笑わせる。" },
    { word: "procrastinate", pos: "verb", japanese: "先延ばしにする", definition: "to delay doing something that needs to be done", example: "I always procrastinate on my tax returns.", exampleJa: "確定申告をいつも先延ばしにしてしまう。" },
    { word: "enthusiasm", pos: "noun", japanese: "熱意", definition: "intense and eager enjoyment or interest", example: "She lost her enthusiasm for the project.", exampleJa: "彼女はそのプロジェクトへの熱意を失った。" }
  ],
...
},
{
  ...
  glossary: [
    { word: "swamped", pos: "adjective", japanese: "忙殺されている", definition: "overwhelmed with an excessive amount of work", example: "I'm swamped with deadlines this month.", exampleJa: "今月は締め切りに忙殺されている。" },
    { word: "slammed", pos: "adjective", japanese: "超多忙な、パンク状態の", definition: "extremely busy, overwhelmed with tasks or customers", example: "We're totally slammed at the office today.", exampleJa: "今日はオフィスで完全にパンク状態だ。" },
    { word: "drowning", pos: "verb", japanese: "（仕事に）溺れている", definition: "being so overwhelmed that one cannot manage", example: "I'm drowning in paperwork right now.", exampleJa: "今、書類仕事に溺れている。" },
    { word: "burning the candle at both ends", pos: "idiom", japanese: "無理をしている、働きすぎている", definition: "working excessively long hours and exhausting oneself", example: "You'll burn out if you keep burning the candle at both ends.", exampleJa: "そんなに無理をし続けたら燃え尽きるよ。" },
    { word: "pile up", pos: "phrasal verb", japanese: "積み重なる、山積みになる", definition: "to accumulate in increasing amounts", example: "Unread messages are piling up in my inbox.", exampleJa: "未読メッセージが受信箱に溜まっている。" },
    { word: "spread thin", pos: "phrase", japanese: "手が回らない、リソース不足", definition: "trying to handle too many things at once with limited resources", example: "The team is spread thin across three projects.", exampleJa: "チームは3つのプロジェクトにまたがって手が回らない。" },
    { word: "running on fumes", pos: "phrase", japanese: "エネルギー切れ寸前、力尽きかけている", definition: "operating with almost no energy or resources left", example: "After the all-nighter, I'm running on fumes.", exampleJa: "徹夜明けで、もうエネルギー切れ寸前だ。" },
    { word: "toll", pos: "noun", japanese: "代償、犠牲", definition: "the damage or suffering caused by something", example: "The long hours took a toll on his health.", exampleJa: "長時間労働は彼の健康に代償をもたらした。" },
    { word: "exhausting", pos: "adjective", japanese: "疲れ果てさせる", definition: "making you feel extremely tired", example: "The twelve-hour shift was absolutely exhausting.", exampleJa: "12時間のシフトは本当に疲れ果てた。" },
    { word: "volume", pos: "noun", japanese: "量", definition: "the amount or quantity of something", example: "The volume of complaints has increased dramatically.", exampleJa: "苦情の量が劇的に増えた。" },
    { word: "keep up", pos: "phrasal verb", japanese: "ついていく、追いつく", definition: "to manage to maintain the same pace or level", example: "I can barely keep up with all the changes.", exampleJa: "すべての変化にかろうじてついていっている。" }
  ],
...
},
{
  ...
  glossary: [
    { word: "chill out", pos: "phrasal verb", japanese: "落ち着く、リラックスする", definition: "to relax and stop being upset or anxious", example: "Just chill out and enjoy the weekend.", exampleJa: "落ち着いて週末を楽しんでよ。" },
    { word: "zen mode", pos: "noun", japanese: "禅モード、完全に落ち着いた状態", definition: "a state of calm, focused relaxation", example: "I'm in zen mode after my morning meditation.", exampleJa: "朝の瞑想の後は禅モードだ。" },
    { word: "Netflix and chill", pos: "phrase", japanese: "ネトフリでまったり（※恋愛的含意あり）", definition: "watching TV and relaxing, but often implies romantic activity", example: "He asked her to Netflix and chill.", exampleJa: "彼は彼女にネトフリでまったりしようと誘った。" },
    { word: "veg out", pos: "phrasal verb", japanese: "ボーッとする、何もせずゴロゴロする", definition: "to relax completely by doing nothing active", example: "I'm going to veg out with some snacks.", exampleJa: "お菓子を食べながらボーッとするつもりだ。" },
    { word: "connotation", pos: "noun", japanese: "含意、連想される意味", definition: "an additional meaning or feeling a word suggests beyond its literal definition", example: "The word 'home' has warm connotations for most people.", exampleJa: "『home』という言葉は多くの人にとって温かい含意がある。" },
    { word: "unwind", pos: "verb", japanese: "くつろぐ、緊張をほどく", definition: "to relax after a period of work or tension", example: "I like to unwind with a good book.", exampleJa: "良い本でくつろぐのが好きだ。" },
    { word: "decompress", pos: "verb", japanese: "ストレスを解消する", definition: "to relax and relieve stress after a demanding period", example: "She needs time to decompress after long shifts.", exampleJa: "長いシフトの後、ストレスを解消する時間が必要だ。" },
    { word: "vegetate", pos: "verb", japanese: "無為に過ごす", definition: "to live in a dull way with no activity or interest", example: "He spent the whole holiday just vegetating at home.", exampleJa: "彼は休暇中ずっと家で無為に過ごした。" },
    { word: "passively", pos: "adverb", japanese: "受動的に", definition: "without active effort or participation", example: "She sat passively during the entire meeting.", exampleJa: "彼女は会議中ずっと受動的に座っていた。" },
    { word: "mental health", pos: "noun", japanese: "メンタルヘルス、心の健康", definition: "a person's emotional and psychological well-being", example: "Taking breaks is crucial for mental health.", exampleJa: "休憩を取ることはメンタルヘルスに不可欠だ。" }
  ],
...
},
{
  ...
  glossary: [
    { word: "road trip", pos: "noun", japanese: "車での長距離旅行", definition: "a long journey taken by car for pleasure", example: "A cross-country road trip is on my bucket list.", exampleJa: "アメリカ横断のロードトリップはやりたいことリストに入っている。" },
    { word: "staycation", pos: "noun", japanese: "自宅での休暇、近場での休暇", definition: "a vacation spent at home or nearby instead of traveling far", example: "Our staycation was surprisingly relaxing and fun.", exampleJa: "自宅での休暇は驚くほどリラックスして楽しかった。" },
    { word: "jet lag", pos: "noun", japanese: "時差ボケ", definition: "tiredness and disorientation from traveling across time zones", example: "It took me three days to recover from jet lag.", exampleJa: "時差ボケから回復するのに3日かかった。" },
    { word: "off the beaten path", pos: "phrase", japanese: "人里離れた、観光客が行かない", definition: "in a place that is not commonly visited by tourists", example: "The best cafés are off the beaten path.", exampleJa: "最高のカフェは観光客が行かない場所にある。" },
    { word: "wanderlust", pos: "noun", japanese: "旅への強い憧れ", definition: "a strong desire to travel and explore the world", example: "Her wanderlust led her to visit thirty countries.", exampleJa: "旅への憧れが彼女を30カ国訪問へと導いた。" },
    { word: "bucket list", pos: "noun", japanese: "死ぬまでにやりたいことリスト", definition: "a list of experiences you want to have before you die", example: "Seeing the Northern Lights is on my bucket list.", exampleJa: "オーロラを見ることは私のやりたいことリストに入っている。" },
    { word: "spontaneous", pos: "adjective", japanese: "自発的な、思いつきの", definition: "done without planning, on impulse", example: "The most spontaneous trips are often the best.", exampleJa: "最も思いつきの旅がしばしば最高だ。" },
    { word: "brutal", pos: "adjective", japanese: "きつい、過酷な", definition: "extremely harsh or severe", example: "The summer heat in Arizona is absolutely brutal.", exampleJa: "アリゾナの夏の暑さは本当に過酷だ。" },
    { word: "disorientation", pos: "noun", japanese: "見当識障害、方向感覚の喪失", definition: "a feeling of confusion about where you are or what is happening", example: "Jet lag causes disorientation and fatigue.", exampleJa: "時差ボケは方向感覚の喪失と疲労を引き起こす。" },
    { word: "grand", pos: "adjective", japanese: "壮大な", definition: "impressive and large in scale", example: "They planned a grand celebration for the anniversary.", exampleJa: "記念日のために壮大なお祝いを企画した。" }
  ],
...
},
{
  ...
  glossary: [
    { word: "TBH", pos: "abbreviation", japanese: "正直に言うと", definition: "to be honest — used before giving a sincere opinion", example: "TBH, I think we should cancel the event.", exampleJa: "正直に言うと、イベントは中止すべきだと思う。" },
    { word: "IMO", pos: "abbreviation", japanese: "私の意見では", definition: "in my opinion — used to express a personal viewpoint", example: "IMO, that was the best episode of the season.", exampleJa: "私の意見では、あれは今シーズン最高のエピソードだった。" },
    { word: "GOAT", pos: "abbreviation", japanese: "史上最高", definition: "greatest of all time — the best ever in a category", example: "Many people consider her the GOAT of tennis.", exampleJa: "多くの人が彼女をテニス史上最高の選手だと考えている。" },
    { word: "IYKYK", pos: "abbreviation", japanese: "分かる人には分かる", definition: "if you know, you know — implying insider knowledge", example: "That hidden bar downtown is amazing — IYKYK.", exampleJa: "ダウンタウンの隠れバーは最高 — 分かる人には分かる。" },
    { word: "NGL", pos: "abbreviation", japanese: "嘘つかないけど、正直", definition: "not gonna lie — used before an honest statement", example: "NGL, I was scared during the horror movie.", exampleJa: "正直、ホラー映画の間怖かった。" },
    { word: "acronym", pos: "noun", japanese: "頭字語", definition: "a word formed from the first letters of other words", example: "NASA is an acronym for National Aeronautics and Space Administration.", exampleJa: "NASAはNational Aeronautics and Space Administrationの頭字語だ。" },
    { word: "sincere", pos: "adjective", japanese: "誠実な、心からの", definition: "genuine and honest in feelings or expression", example: "Her apology seemed completely sincere.", exampleJa: "彼女の謝罪は完全に心からのもののようだった。" },
    { word: "insider", pos: "noun/adjective", japanese: "内部の人、インサイダー", definition: "someone with special knowledge of a group or organization", example: "Only insiders know about the secret entrance.", exampleJa: "秘密の入口を知っているのはインサイダーだけだ。" },
    { word: "admission", pos: "noun", japanese: "告白、認めること", definition: "a statement acknowledging something is true", example: "His admission of guilt surprised everyone.", exampleJa: "彼の罪の告白は皆を驚かせた。" },
    { word: "migrate", pos: "verb", japanese: "移行する、移動する", definition: "to move from one place or medium to another", example: "Many businesses migrated to online platforms.", exampleJa: "多くの企業がオンラインプラットフォームに移行した。" },
    { word: "reshape", pos: "verb", japanese: "形を変える、再構築する", definition: "to change the form or structure of something", example: "Technology has reshaped modern education.", exampleJa: "テクノロジーは現代の教育を再構築した。" },
    { word: "blending", pos: "noun", japanese: "融合", definition: "the process of mixing two things together", example: "The blending of cultures creates something new.", exampleJa: "文化の融合は新しいものを生み出す。" }
  ],
...
},
{
  ...
  glossary: [
    { word: "make do with", pos: "phrasal verb", japanese: "〜で間に合わせる", definition: "to manage with something that is not ideal or sufficient", example: "We had to make do with older equipment.", exampleJa: "古い機材で間に合わせなければならなかった。" },
    { word: "make a point of", pos: "collocation", japanese: "〜することを心がける", definition: "to deliberately do something because you think it is important", example: "She makes a point of arriving early.", exampleJa: "彼女は早く到着することを心がけている。" },
    { word: "make sense", pos: "collocation", japanese: "道理にかなう、理解できる", definition: "to be logical or understandable", example: "Your explanation makes sense to me now.", exampleJa: "あなたの説明が今は理解できる。" },
    { word: "make up for", pos: "phrasal verb", japanese: "〜を埋め合わせる", definition: "to compensate for something lost or lacking", example: "He made up for lost time by working weekends.", exampleJa: "彼は週末働いて失った時間を埋め合わせた。" },
    { word: "make a difference", pos: "collocation", japanese: "違いを生む、影響を与える", definition: "to have a meaningful effect or impact", example: "Small gestures can make a real difference.", exampleJa: "小さな心遣いが本当に大きな違いを生む。" },
    { word: "make way for", pos: "collocation", japanese: "〜に道を譲る、〜の余地を作る", definition: "to create space or opportunity for something new", example: "Old buildings were demolished to make way for offices.", exampleJa: "古いビルがオフィスのために取り壊された。" },
    { word: "make room for", pos: "collocation", japanese: "〜のための余地を作る", definition: "to create space for something or someone", example: "We rearranged the office to make room for interns.", exampleJa: "インターンのためにオフィスを模様替えした。" },
    { word: "make headway", pos: "collocation", japanese: "進展する", definition: "to make progress, especially when it is difficult", example: "Negotiations are finally making headway.", exampleJa: "交渉がようやく進展している。" },
    { word: "make the best of", pos: "collocation", japanese: "〜を最大限に活用する", definition: "to deal with a bad situation as well as possible", example: "Let's make the best of this rainy weekend.", exampleJa: "この雨の週末を最大限に楽しもう。" },
    { word: "recruitment", pos: "noun", japanese: "採用活動", definition: "the process of finding and hiring new employees", example: "Recruitment has been paused until next quarter.", exampleJa: "採用活動は来四半期まで中断されている。" },
    { word: "resilient", pos: "adjective", japanese: "回復力のある、立ち直りが早い", definition: "able to recover quickly from difficulties", example: "Children are remarkably resilient after setbacks.", exampleJa: "子供は挫折の後、驚くほど立ち直りが早い。" },
...
,
{
  ...
  glossary: [
    { word: "take for granted", pos: "collocation", japanese: "〜を当たり前と思う", definition: "to fail to appreciate something because you are used to it", example: "Don't take your health for granted.", exampleJa: "健康を当たり前だと思ってはいけない。" },
    { word: "take into account", pos: "collocation", japanese: "〜を考慮に入れる", definition: "to consider something when making a decision", example: "We must take costs into account before deciding.", exampleJa: "決定する前にコストを考慮に入れなければならない。" },
    { word: "take a toll on", pos: "collocation", japanese: "〜に打撃を与える", definition: "to cause damage, suffering, or loss over time", example: "Long hours took a toll on her health.", exampleJa: "長時間労働が彼女の健康に打撃を与えた。" },
    { word: "take the plunge", pos: "collocation", japanese: "思い切ってやる", definition: "to decide to do something risky or difficult after hesitating", example: "He finally took the plunge and quit his job.", exampleJa: "彼はついに思い切って仕事を辞めた。" },
    { word: "take it upon oneself", pos: "collocation", japanese: "自ら進んで引き受ける", definition: "to decide to do something without being asked", example: "She took it upon herself to organize the event.", exampleJa: "彼女は自ら進んでイベントの企画を引き受けた。" },
    { word: "take heart", pos: "collocation", japanese: "勇気づけられる", definition: "to feel encouraged or hopeful", example: "Take heart—things will improve soon.", exampleJa: "元気を出して——状況はすぐに良くなるよ。" },
    { word: "take at face value", pos: "collocation", japanese: "額面通りに受け取る", definition: "to accept something as it appears without questioning it", example: "I wouldn't take his promises at face value.", exampleJa: "彼の約束を額面通りに受け取らない方がいい。" },
    { word: "take a step back", pos: "collocation", japanese: "一歩引いて考える", definition: "to pause and reconsider a situation from a distance", example: "Let's take a step back and rethink this.", exampleJa: "一歩引いてこれを考え直そう。" },
    { word: "take action", pos: "collocation", japanese: "行動を起こす", definition: "to do something in response to a situation", example: "The government must take action on climate change.", exampleJa: "政府は気候変動に対して行動を起こさなければならない。" },
    { word: "disrupts", pos: "verb", japanese: "混乱させる", definition: "to interrupt or throw into disorder", example: "The storm disrupted flights across the region.", exampleJa: "嵐が地域全体のフライトを混乱させた。" },
...
,
{
  ...
  glossary: [
    { word: "get the hang of", pos: "phrasal verb", japanese: "コツをつかむ", definition: "to learn how to do something, especially after practice", example: "It took me weeks to get the hang of driving.", exampleJa: "運転のコツをつかむのに数週間かかった。" },
    { word: "get around to", pos: "phrasal verb", japanese: "〜する時間をやっと見つける", definition: "to finally do something after a delay", example: "I never got around to reading that book.", exampleJa: "その本を読む時間をついに見つけられなかった。" },
    { word: "get carried away", pos: "phrasal verb", japanese: "夢中になりすぎる、調子に乗る", definition: "to become overly excited or enthusiastic", example: "She got carried away shopping and overspent.", exampleJa: "彼女は買い物に夢中になりすぎてお金を使いすぎた。" },
    { word: "get away with", pos: "phrasal verb", japanese: "〜を罰を受けずにやり遂げる", definition: "to do something wrong without being punished", example: "He always gets away with coming in late.", exampleJa: "彼はいつも遅刻しても罰を受けない。" },
    { word: "get through", pos: "phrasal verb", japanese: "〜を乗り越える、切り抜ける", definition: "to manage to complete or survive something difficult", example: "We got through the audit without any issues.", exampleJa: "私たちは問題なく監査を乗り越えた。" },
    { word: "get along with", pos: "phrasal verb", japanese: "〜と仲良くやる", definition: "to have a friendly relationship with someone", example: "Do you get along with your coworkers?", exampleJa: "同僚と仲良くやっていますか？" },
    { word: "get rid of", pos: "phrasal verb", japanese: "〜を処分する、取り除く", definition: "to remove or dispose of something unwanted", example: "We need to get rid of this old sofa.", exampleJa: "この古いソファを処分する必要がある。" },
    { word: "get bogged down", pos: "phrasal verb", japanese: "行き詰まる、泥沼にはまる", definition: "to become stuck or slowed by difficulties", example: "Don't get bogged down in minor details.", exampleJa: "些細な詳細にとらわれて行き詰まるな。" },
    { word: "get to the bottom of", pos: "phrasal verb", japanese: "〜の真相を突き止める", definition: "to discover the true cause or explanation of something", example: "We need to get to the bottom of this error.", exampleJa: "このエラーの真相を突き止める必要がある。" },
    { word: "get on the wrong side of", pos: "phrasal verb", japanese: "〜に目をつけられる、敵に回す", definition: "to do something that makes someone angry or hostile toward you", example: "You don't want to get on the wrong side of management.", exampleJa: "経営陣を敵に回したくはないだろう。" },
    { word: "jaywalking", pos: "noun", japanese: "信号無視の横断", definition: "crossing the street illegally or carelessly", example: "Jaywalking can result in a fine in some cities.", exampleJa: "信号無視の横断は一部の都市では罰金になりうる。" },
...
,
{
  ...
  glossary: [
    { word: "put up with", pos: "phrasal verb", japanese: "〜を我慢する", definition: "to tolerate something unpleasant without complaining", example: "I can't put up with this noise anymore.", exampleJa: "この騒音にはもう我慢できない。" },
    { word: "put forward", pos: "phrasal verb", japanese: "〜を提案する", definition: "to suggest an idea or plan for consideration", example: "She put forward a bold new strategy.", exampleJa: "彼女は大胆な新戦略を提案した。" },
    { word: "put off", pos: "phrasal verb", japanese: "〜を延期する、先延ばしにする", definition: "to postpone or delay something", example: "Stop putting off your dentist appointment.", exampleJa: "歯医者の予約を先延ばしにするのはやめなさい。" },
    { word: "put down", pos: "phrasal verb", japanese: "〜をけなす", definition: "to criticize someone or something in a way that makes them seem foolish", example: "He's always putting down other people's ideas.", exampleJa: "彼はいつも他人のアイデアをけなしている。" },
    { word: "put together", pos: "phrasal verb", japanese: "〜を組み立てる、編成する", definition: "to assemble or organize something from different parts", example: "We put together a presentation in two days.", exampleJa: "2日でプレゼンを組み立てた。" },
    { word: "put aside", pos: "phrasal verb", japanese: "〜を脇に置く、棚上げにする", definition: "to temporarily ignore or set aside differences or feelings", example: "Let's put aside our disagreements for now.", exampleJa: "今は意見の相違を脇に置こう。" },
    { word: "put out", pos: "phrasal verb", japanese: "〜を発表する、出す", definition: "to publish or release something for public consumption", example: "The company put out a press release yesterday.", exampleJa: "会社は昨日プレスリリースを発表した。" },
    { word: "put on the map", pos: "collocation", japanese: "〜を有名にする", definition: "to make something well-known or recognized", example: "That viral video put the brand on the map.", exampleJa: "そのバイラル動画がブランドを有名にした。" },
    { word: "put into action", pos: "collocation", japanese: "〜を実行に移す", definition: "to begin implementing a plan or idea", example: "It's time to put our plans into action.", exampleJa: "計画を実行に移す時だ。" },
    { word: "put yourself out there", pos: "collocation", japanese: "思い切って自分をさらけ出す", definition: "to make yourself vulnerable by trying something new publicly", example: "You have to put yourself out there to succeed.", exampleJa: "成功するには思い切って自分をさらけ出さなければならない。" },
...
,
{
  ...
  glossary: [
    { word: "come up with", pos: "phrasal verb", japanese: "〜を思いつく、考え出す", definition: "to produce an idea, plan, or solution", example: "Can you come up with a better approach?", exampleJa: "もっと良いアプローチを思いつけますか？" },
    { word: "come across", pos: "phrasal verb", japanese: "〜に偶然出くわす", definition: "to find or encounter something or someone by chance", example: "I came across an old photo in the attic.", exampleJa: "屋根裏部屋で古い写真に偶然出くわした。" },
    { word: "come to terms with", pos: "phrasal verb", japanese: "〜を受け入れる", definition: "to accept a difficult or unpleasant situation", example: "She came to terms with the loss gradually.", exampleJa: "彼女は徐々にその喪失を受け入れた。" },
    { word: "come around", pos: "phrasal verb", japanese: "考えを変える、同意するようになる", definition: "to change your opinion and agree with something you previously opposed", example: "He eventually came around to our way of thinking.", exampleJa: "彼はやがて私たちの考え方に同意するようになった。" },
    { word: "come into one's own", pos: "phrasal verb", japanese: "本領を発揮する", definition: "to begin to show one's true abilities or reach full potential", example: "She really came into her own as team leader.", exampleJa: "彼女はチームリーダーとして本領を発揮した。" },
    { word: "come about", pos: "phrasal verb", japanese: "生じる、起こる", definition: "to happen or occur, especially in a way that is not planned", example: "How did this misunderstanding come about?", exampleJa: "この誤解はどのようにして起こったのか？" },
    { word: "come to grips with", pos: "phrasal verb", japanese: "〜に本気で取り組む", definition: "to begin to understand and deal with something difficult", example: "The team came to grips with the new regulations.", exampleJa: "チームは新しい規制に本気で取り組んだ。" },
    { word: "come down to", pos: "phrasal verb", japanese: "結局〜に帰着する", definition: "to be essentially a matter of", example: "Success comes down to hard work and timing.", exampleJa: "成功は結局、努力とタイミングに帰着する。" },
    { word: "come up against", pos: "phrasal verb", japanese: "〜に直面する", definition: "to face a problem or difficulty", example: "We came up against unexpected legal obstacles.", exampleJa: "予期しない法的障害に直面した。" },
    { word: "disruption", pos: "noun", japanese: "破壊的変化", definition: "a radical change that upsets traditional methods or markets", example: "Digital disruption is reshaping every industry.", exampleJa: "デジタルによる破壊的変化があらゆる業界を再形成している。" },
...
,
{
  ...
  glossary: [
    { word: "turn things around", pos: "phrasal verb", japanese: "状況を好転させる", definition: "to reverse a bad situation and make it successful", example: "The new CEO turned things around in one year.", exampleJa: "新CEOが1年で状況を好転させた。" },
    { word: "turn down", pos: "phrasal verb", japanese: "〜を断る", definition: "to refuse or reject an offer or request", example: "She turned down the job offer politely.", exampleJa: "彼女は丁寧にその求人を断った。" },
    { word: "turn out", pos: "phrasal verb", japanese: "結局〜であることがわかる", definition: "to prove to be the case; to have a particular result", example: "The project turned out to be a huge success.", exampleJa: "そのプロジェクトは結局大成功だった。" },
    { word: "turn a blind eye", pos: "collocation", japanese: "見て見ぬふりをする", definition: "to deliberately ignore something wrong or unpleasant", example: "Management turned a blind eye to the violations.", exampleJa: "経営陣は違反に見て見ぬふりをした。" },
    { word: "turn one's attention to", pos: "collocation", japanese: "〜に注意を向ける", definition: "to start focusing on a new subject or issue", example: "Let's turn our attention to the budget now.", exampleJa: "さあ、予算に注意を向けよう。" },
    { word: "turn a profit", pos: "collocation", japanese: "黒字にする、利益を出す", definition: "to start making money after a period of losses", example: "The startup finally turned a profit in year three.", exampleJa: "そのスタートアップはようやく3年目に黒字になった。" },
    { word: "turn against", pos: "phrasal verb", japanese: "〜に反旗を翻す、敵対する", definition: "to stop supporting someone and become hostile", example: "Voters turned against the ruling party.", exampleJa: "有権者は与党に反旗を翻した。" },
    { word: "consecutive", pos: "adjective", japanese: "連続した", definition: "following one after another without interruption", example: "She won the award three consecutive times.", exampleJa: "彼女は3年連続でその賞を受賞した。" },
    { word: "lucrative", pos: "adjective", japanese: "収益性の高い", definition: "producing a great deal of profit", example: "Real estate can be a lucrative investment.", exampleJa: "不動産は収益性の高い投資になりうる。" },
    { word: "rally behind", pos: "phrasal verb", japanese: "〜を支持して結集する", definition: "to unite in support of someone or something", example: "The community rallied behind the local school.", exampleJa: "コミュニティは地元の学校を支持して結集した。" },
...
,
{
  ...
  glossary: [
    { word: "run into", pos: "phrasal verb", japanese: "〜に偶然出くわす／〜にぶつかる", definition: "to encounter something unexpectedly, especially a problem", example: "We ran into several technical issues during testing.", exampleJa: "テスト中にいくつかの技術的問題にぶつかった。" },
    { word: "run out of", pos: "phrasal verb", japanese: "〜を使い果たす", definition: "to use all of something so that none is left", example: "We're running out of time to finish the project.", exampleJa: "プロジェクトを終える時間がなくなってきている。" },
    { word: "run the risk of", pos: "collocation", japanese: "〜のリスクを冒す", definition: "to do something that might have a bad result", example: "You run the risk of losing your investment.", exampleJa: "投資を失うリスクを冒すことになる。" },
    { word: "run the numbers", pos: "collocation", japanese: "数字を計算する、分析する", definition: "to calculate or analyze financial data", example: "Let me run the numbers before we commit.", exampleJa: "コミットする前に数字を分析させてください。" },
    { word: "run circles around", pos: "collocation", japanese: "〜をはるかに凌ぐ", definition: "to be much better or faster than someone else", example: "Her team runs circles around the competition.", exampleJa: "彼女のチームは競合をはるかに凌いでいる。" },
    { word: "run scared", pos: "collocation", japanese: "恐れて慌てる", definition: "to feel threatened and act out of fear", example: "The incumbent is running scared before the election.", exampleJa: "現職者は選挙前に恐れて慌てている。" },
    { word: "in the long run", pos: "collocation", japanese: "長い目で見れば", definition: "over a long period of time; eventually", example: "This investment will pay off in the long run.", exampleJa: "この投資は長い目で見れば報われるだろう。" },
    { word: "run a tight ship", pos: "collocation", japanese: "厳格に管理する", definition: "to manage an organization strictly and efficiently", example: "The new principal runs a very tight ship.", exampleJa: "新しい校長はとても厳格に管理している。" },
    { word: "run like clockwork", pos: "collocation", japanese: "時計のように正確に動く", definition: "to operate smoothly and without problems", example: "After the fix, the system runs like clockwork.", exampleJa: "修正後、システムは時計のように正確に動いている。" },
    { word: "running low on", pos: "phrasal verb", japanese: "〜が少なくなっている", definition: "to have very little of something remaining", example: "We're running low on printer paper.", exampleJa: "プリンター用紙が少なくなっている。" },
    { word: "defaulting", pos: "verb", japanese: "債務不履行になる", definition: "failing to fulfill a financial obligation", example: "Several firms risk defaulting on their loans.", exampleJa: "いくつかの企業がローンの債務不履行のリスクにある。" },
...
,
{
  ...
  glossary: [
    { word: "break through", pos: "phrasal verb", japanese: "突破する、突き抜ける", definition: "to successfully overcome a barrier or achieve a significant result", example: "The team finally broke through a major technical barrier.", exampleJa: "チームはついに大きな技術的障壁を突破した。" },
    { word: "break the ice", pos: "collocation", japanese: "場の雰囲気を和ませる", definition: "to do something to relieve tension or start a conversation", example: "A joke can help break the ice at meetings.", exampleJa: "冗談が会議の場の雰囲気を和ませるのに役立つ。" },
    { word: "break new ground", pos: "collocation", japanese: "新境地を開く", definition: "to do something innovative that has not been done before", example: "This research breaks new ground in genetics.", exampleJa: "この研究は遺伝学で新境地を開いている。" },
    { word: "break down", pos: "phrasal verb", japanese: "故障する、壊れる", definition: "to stop working due to a mechanical or technical failure", example: "The car broke down on the highway.", exampleJa: "車が高速道路で故障した。" },
    { word: "break even", pos: "collocation", japanese: "損益分岐点に達する", definition: "to reach a point where income equals expenses", example: "The restaurant expects to break even by December.", exampleJa: "そのレストランは12月までに損益分岐点に達する見込みだ。" },
    { word: "break away from", pos: "phrasal verb", japanese: "〜から脱却する", definition: "to free oneself from a tradition, group, or pattern", example: "She broke away from her family's expectations.", exampleJa: "彼女は家族の期待から脱却した。" },
    { word: "break with tradition", pos: "collocation", japanese: "伝統を打破する", definition: "to stop following established customs or practices", example: "The designer broke with tradition by using recycled materials.", exampleJa: "デザイナーはリサイクル素材を使って伝統を打破した。" },
    { word: "break free from", pos: "phrasal verb", japanese: "〜から解放される", definition: "to escape from a constraint or limitation", example: "He wanted to break free from routine.", exampleJa: "彼はルーティンから解放されたかった。" },
    { word: "big break", pos: "collocation", japanese: "大きなチャンス", definition: "an important opportunity that leads to success", example: "Landing that client was our big break.", exampleJa: "あのクライアントを獲得したことが大きなチャンスだった。" },
    { word: "breakthrough", pos: "noun", japanese: "画期的な進展", definition: "a sudden important development or discovery", example: "Scientists announced a breakthrough in cancer research.", exampleJa: "科学者たちは癌研究における画期的な進展を発表した。" },
    { word: "oversaturated", pos: "adjective", japanese: "過飽和の、供給過剰の", definition: "having too much of something, beyond what the market can absorb", example: "The app market is completely oversaturated.", exampleJa: "アプリ市場は完全に供給過剰だ。" },
...
,
{
  ...
  glossary: [
    { word: "hold your ground", pos: "collocation", japanese: "自分の立場を譲らない", definition: "to refuse to change your position or opinion under pressure", example: "She held her ground despite strong opposition.", exampleJa: "強い反対にもかかわらず、彼女は自分の立場を譲らなかった。" },
    { word: "hold off", pos: "phrasal verb", japanese: "〜を延期する、待つ", definition: "to delay or postpone doing something", example: "Let's hold off on the decision until Friday.", exampleJa: "金曜日まで決定を延期しよう。" },
    { word: "hold accountable", pos: "collocation", japanese: "〜に責任を問う", definition: "to require someone to answer for their actions", example: "Leaders must be held accountable for their decisions.", exampleJa: "リーダーは自分の決定に責任を問われなければならない。" },
    { word: "hold water", pos: "collocation", japanese: "筋が通る、論理的に成り立つ", definition: "to be logical and consistent; to withstand examination", example: "His alibi doesn't hold water under investigation.", exampleJa: "彼のアリバイは調査に耐えられない。" },
    { word: "hold the line", pos: "collocation", japanese: "譲歩しない、防衛線を守る", definition: "to maintain a firm position and refuse to yield", example: "The union held the line on wages during talks.", exampleJa: "組合は交渉中、賃金で譲歩しなかった。" },
    { word: "hold up", pos: "phrasal verb", japanese: "持ちこたえる、通用する", definition: "to remain valid or withstand pressure or scrutiny", example: "The theory didn't hold up to peer review.", exampleJa: "その理論は査読に持ちこたえなかった。" },
    { word: "hold true", pos: "collocation", japanese: "当てはまる、有効である", definition: "to remain valid or applicable", example: "This principle holds true across cultures.", exampleJa: "この原則は文化を超えて当てはまる。" },
    { word: "hold your nerve", pos: "collocation", japanese: "冷静さを保つ", definition: "to remain calm and determined during a difficult situation", example: "You need to hold your nerve during the presentation.", exampleJa: "プレゼン中は冷静さを保つ必要がある。" },
    { word: "hold fire", pos: "collocation", japanese: "行動を控える、様子を見る", definition: "to wait and not take action immediately", example: "Hold fire until we have more information.", exampleJa: "もっと情報が入るまで行動を控えよう。" },
    { word: "opposing counsel", pos: "noun", japanese: "相手方弁護士", definition: "the lawyer or legal team representing the other side", example: "Opposing counsel filed a motion to dismiss.", exampleJa: "相手方弁護士が却下申立てを提出した。" },
...
,
{
  ...
  glossary: [
    { word: "pull off", pos: "phrasal verb", japanese: "〜をやり遂げる（困難なことを）", definition: "to succeed in doing something difficult or unexpected", example: "They pulled off a flawless product launch.", exampleJa: "彼らは完璧な製品ローンチをやり遂げた。" },
    { word: "pull strings", pos: "collocation", japanese: "コネを使う、裏で手を回す", definition: "to use personal connections or influence to get something done", example: "He pulled strings to get his son the internship.", exampleJa: "彼はコネを使って息子にインターンシップを得させた。" },
    { word: "pull together", pos: "phrasal verb", japanese: "〜をかき集める、まとめる", definition: "to gather or assemble resources, people, or ideas", example: "We pulled together a team in just two days.", exampleJa: "わずか2日でチームをかき集めた。" },
    { word: "pull the plug on", pos: "collocation", japanese: "〜を中止する、打ち切る", definition: "to stop supporting or funding something; to end it", example: "The studio pulled the plug on the film.", exampleJa: "スタジオはその映画を打ち切った。" },
    { word: "pull no punches", pos: "collocation", japanese: "遠慮なく言う、容赦しない", definition: "to speak honestly and directly without trying to be polite", example: "The critic pulled no punches in her review.", exampleJa: "その批評家はレビューで遠慮なく言った。" },
    { word: "pull your weight", pos: "collocation", japanese: "自分の役割を果たす", definition: "to do your fair share of work in a group", example: "Everyone needs to pull their weight on this team.", exampleJa: "このチームでは全員が自分の役割を果たす必要がある。" },
    { word: "pulled in different directions", pos: "collocation", japanese: "異なる方向に引っ張られる", definition: "to face conflicting demands or pressures", example: "Parents are often pulled in different directions.", exampleJa: "親はしばしば異なる方向に引っ張られる。" },
    { word: "against all odds", pos: "collocation", japanese: "あらゆる困難にもかかわらず", definition: "despite very low probability of success", example: "She recovered against all odds after the accident.", exampleJa: "あらゆる困難にもかかわらず、事故後に回復した。" },
    { word: "leveraging", pos: "verb", japanese: "〜を活用する", definition: "using something to maximum advantage", example: "We're leveraging AI to improve customer service.", exampleJa: "AIを活用してカスタマーサービスを改善している。" },
    { word: "double down", pos: "phrasal verb", japanese: "さらに力を入れる、倍賭けする", definition: "to increase one's commitment or effort, especially after a setback", example: "The company doubled down on its marketing budget.", exampleJa: "会社はマーケティング予算をさらに増やした。" },
...
,
{
  ...
  glossary: [
    { word: "call the shots", pos: "collocation", japanese: "仕切る、主導権を握る", definition: "to be the person who makes the important decisions", example: "In this company, the founder still calls the shots.", exampleJa: "この会社では、創業者がまだ仕切っている。" },
    { word: "call into question", pos: "collocation", japanese: "〜に疑問を投げかける", definition: "to cause doubt about something previously accepted", example: "New evidence called the theory into question.", exampleJa: "新しい証拠がその理論に疑問を投げかけた。" },
    { word: "call for", pos: "phrasal verb", japanese: "〜を求める、要求する", definition: "to publicly demand or request something", example: "Activists called for immediate reform.", exampleJa: "活動家たちは即座の改革を求めた。" },
    { word: "call it a day", pos: "collocation", japanese: "今日はここまでにする", definition: "to decide to stop working for the day", example: "It's 7 PM—let's call it a day.", exampleJa: "もう午後7時だ——今日はここまでにしよう。" },
    { word: "call a meeting", pos: "collocation", japanese: "会議を招集する", definition: "to arrange for people to come together for a meeting", example: "The director called a meeting for 9 AM.", exampleJa: "ディレクターが午前9時に会議を招集した。" },
    { word: "call on", pos: "phrasal verb", japanese: "〜に求める、指名する", definition: "to ask someone to do something or to speak", example: "The teacher called on me to answer first.", exampleJa: "先生が最初に答えるよう私を指名した。" },
    { word: "call off", pos: "phrasal verb", japanese: "〜を中止する", definition: "to cancel something that was planned", example: "They called off the outdoor event due to rain.", exampleJa: "雨のため屋外イベントを中止した。" },
    { word: "the right call", pos: "collocation", japanese: "正しい判断", definition: "the correct decision in a given situation", example: "Hiring her turned out to be the right call.", exampleJa: "彼女を雇ったのは正しい判断だった。" },
    { word: "rebalancing", pos: "noun", japanese: "リバランス（資産配分の見直し）", definition: "adjusting the allocation of assets in a portfolio", example: "Annual rebalancing helps manage portfolio risk.", exampleJa: "年次のリバランスはポートフォリオのリスク管理に役立つ。" },
    { word: "overweight", pos: "adjective", japanese: "オーバーウェイト（比率が高すぎる）", definition: "having a larger allocation than the benchmark or target", example: "The fund is overweight in technology stocks.", exampleJa: "そのファンドはテクノロジー株がオーバーウェイトだ。" },
...
,
{
  ...
  glossary: [
    { word: "keep up with", pos: "phrasal verb", japanese: "〜に遅れずについていく", definition: "to move or progress at the same rate as others", example: "It's hard to keep up with all the new technology.", exampleJa: "新しいテクノロジーすべてについていくのは難しい。" },
    { word: "keep track of", pos: "collocation", japanese: "〜を把握する、追跡する", definition: "to monitor or stay informed about something", example: "Use a spreadsheet to keep track of expenses.", exampleJa: "スプレッドシートを使って経費を把握しよう。" },
    { word: "keep in mind", pos: "collocation", japanese: "〜を心に留めておく", definition: "to remember or consider something important", example: "Keep in mind that deadlines are non-negotiable.", exampleJa: "締め切りは交渉の余地がないことを心に留めておいてください。" },
    { word: "keep at bay", pos: "collocation", japanese: "〜を寄せ付けない、抑える", definition: "to prevent something harmful from coming too close", example: "Strong defenses kept the enemy at bay.", exampleJa: "強力な防御が敵を寄せ付けなかった。" },
    { word: "keep a close eye on", pos: "collocation", japanese: "〜を注意深く見守る", definition: "to watch something carefully and continuously", example: "Keep a close eye on the market this week.", exampleJa: "今週は市場を注意深く見守ってください。" },
    { word: "keep one's cool", pos: "collocation", japanese: "冷静さを保つ", definition: "to remain calm in a stressful situation", example: "She kept her cool during the heated argument.", exampleJa: "激しい議論の最中も彼女は冷静さを保った。" },
    { word: "keep things in perspective", pos: "collocation", japanese: "物事を大局的に見る", definition: "to maintain a balanced and realistic view of a situation", example: "Try to keep things in perspective when stressed.", exampleJa: "ストレスを感じたときは物事を大局的に見るようにしよう。" },
    { word: "keep pace with", pos: "collocation", japanese: "〜と歩調を合わせる", definition: "to develop or progress at the same speed as something else", example: "Salaries haven't kept pace with inflation.", exampleJa: "給与はインフレに歩調を合わせていない。" },
    { word: "keep sight of", pos: "collocation", japanese: "〜を見失わない", definition: "to continue to be aware of something important", example: "Don't lose sight of your original goals.", exampleJa: "当初の目標を見失うな。" },
    { word: "drawdown", pos: "noun", japanese: "ドローダウン（最大下落幅）", definition: "the peak-to-trough decline in the value of an investment", example: "The fund experienced a 15% drawdown in March.", exampleJa: "そのファンドは3月に15%のドローダウンを経験した。" },
    { word: "volatility", pos: "noun", japanese: "ボラティリティ（変動性）", definition: "the degree of variation in the price of an asset over time", example: "High volatility creates both risk and opportunity.", exampleJa: "高いボラティリティはリスクと機会の両方を生む。" },
...
,
{
  ...
  glossary: [
    { word: "set the tone", pos: "collocation", japanese: "雰囲気を決める、方向性を示す", definition: "to establish the mood or attitude for something that follows", example: "The opening speech set the tone for the conference.", exampleJa: "開会のスピーチが会議の雰囲気を決めた。" },
    { word: "set a precedent", pos: "collocation", japanese: "前例を作る", definition: "to establish a standard or example for future actions", example: "This ruling sets a dangerous precedent for free speech.", exampleJa: "この判決は言論の自由にとって危険な前例を作る。" },
    { word: "set apart", pos: "phrasal verb", japanese: "〜を際立たせる、差別化する", definition: "to make someone or something different and special", example: "Attention to detail sets this brand apart.", exampleJa: "細部へのこだわりがこのブランドを際立たせている。" },
    { word: "set in motion", pos: "collocation", japanese: "〜を始動させる、動き出させる", definition: "to start a process or series of events", example: "The reforms set sweeping changes in motion.", exampleJa: "改革が大規模な変化を始動させた。" },
    { word: "set the stage for", pos: "collocation", japanese: "〜の舞台を整える、下地を作る", definition: "to create the conditions for something to happen", example: "Low interest rates set the stage for a housing boom.", exampleJa: "低金利が住宅ブームの下地を作った。" },
    { word: "set expectations", pos: "collocation", japanese: "期待値を設定する", definition: "to establish what people should anticipate or aim for", example: "The manager set clear expectations for the quarter.", exampleJa: "マネージャーが四半期の期待値を明確に設定した。" },
    { word: "set aside", pos: "phrasal verb", japanese: "〜を脇に置く、確保する", definition: "to save something for a special purpose or ignore temporarily", example: "Set aside time each week for strategic planning.", exampleJa: "毎週、戦略的計画のための時間を確保しよう。" },
    { word: "set up", pos: "phrasal verb", japanese: "〜を設立する、設置する", definition: "to establish or create an organization or system", example: "They set up a task force to investigate the issue.", exampleJa: "問題を調査するためにタスクフォースを設立した。" },
    { word: "set a new standard", pos: "collocation", japanese: "新しい基準を打ち立てる", definition: "to establish a higher level of quality or performance", example: "This product sets a new standard for the industry.", exampleJa: "この製品は業界に新しい基準を打ち立てた。" },
    { word: "cross-functional", pos: "adjective", japanese: "部門横断的な", definition: "involving people from different departments working together", example: "Cross-functional teams solve problems more creatively.", exampleJa: "部門横断的なチームはより創造的に問題を解決する。" },
...
,
{
  ...
  glossary: [
    { word: "bring to the table", pos: "collocation", japanese: "〜を提供する、持ち寄る", definition: "to contribute something valuable to a discussion or project", example: "What skills do you bring to the table?", exampleJa: "どんなスキルを提供できますか？" },
    { word: "bring up", pos: "phrasal verb", japanese: "〜を持ち出す、話題に出す", definition: "to mention or introduce a topic for discussion", example: "She brought up the budget issue at the meeting.", exampleJa: "彼女は会議で予算の問題を持ち出した。" },
    { word: "bring to light", pos: "collocation", japanese: "〜を明るみに出す", definition: "to reveal or make something known that was hidden", example: "The audit brought several errors to light.", exampleJa: "監査がいくつかのエラーを明るみに出した。" },
    { word: "bring about", pos: "phrasal verb", japanese: "〜を引き起こす、もたらす", definition: "to cause something to happen", example: "Technology has brought about sweeping social changes.", exampleJa: "テクノロジーが広範な社会的変化をもたらした。" },
    { word: "bring to the fore", pos: "collocation", japanese: "〜を前面に出す、浮き彫りにする", definition: "to make something more noticeable or important", example: "The crisis brought leadership issues to the fore.", exampleJa: "危機がリーダーシップの問題を浮き彫りにした。" },
    { word: "bring in", pos: "phrasal verb", japanese: "〜を招く、導入する", definition: "to involve someone or something from outside", example: "We brought in a specialist to fix the problem.", exampleJa: "問題を解決するために専門家を招いた。" },
    { word: "bring down", pos: "phrasal verb", japanese: "〜を引き下げる、減少させる", definition: "to reduce or lower something", example: "New policies brought down the unemployment rate.", exampleJa: "新しい政策が失業率を引き下げた。" },
    { word: "bring out the best in", pos: "collocation", japanese: "〜の最良の部分を引き出す", definition: "to cause someone to show their finest qualities", example: "Great managers bring out the best in their teams.", exampleJa: "優れたマネージャーはチームの最良の部分を引き出す。" },
    { word: "constructive", pos: "adjective", japanese: "建設的な", definition: "intended to be helpful or improve a situation", example: "Please provide constructive feedback on the draft.", exampleJa: "草稿に建設的なフィードバックをお願いします。" },
    { word: "undermining", pos: "verb", japanese: "〜を蝕む、弱体化させる", definition: "gradually weakening or damaging something", example: "Constant criticism was undermining her confidence.", exampleJa: "絶え間ない批判が彼女の自信を蝕んでいた。" },
...
,
{
  ...
  glossary: [
    { word: "fall through", pos: "phrasal verb", japanese: "失敗に終わる、不成立になる", definition: "to fail to happen or be completed as planned", example: "The merger deal fell through at the last minute.", exampleJa: "合併の取引が土壇場で不成立になった。" },
    { word: "fall apart", pos: "phrasal verb", japanese: "崩壊する、ばらばらになる", definition: "to break into pieces or collapse completely", example: "The coalition government fell apart after six months.", exampleJa: "連立政権は6か月後に崩壊した。" },
    { word: "fall behind", pos: "phrasal verb", japanese: "遅れをとる", definition: "to fail to keep up with others or with a schedule", example: "Don't fall behind on your loan payments.", exampleJa: "ローンの返済で遅れをとらないでください。" },
    { word: "fall into place", pos: "collocation", japanese: "うまく収まる、すべてがまとまる", definition: "to gradually become clear or organized without much effort", example: "Once we hired the right person, everything fell into place.", exampleJa: "適切な人を雇ったら、すべてがうまく収まった。" },
    { word: "fall short of", pos: "collocation", japanese: "〜に達しない、及ばない", definition: "to fail to reach a particular level or standard", example: "Sales fell short of projections by ten percent.", exampleJa: "売上は予測に10%及ばなかった。" },
    { word: "fall prey to", pos: "collocation", japanese: "〜の餌食になる", definition: "to be harmed or deceived by something negative", example: "Many investors fell prey to the Ponzi scheme.", exampleJa: "多くの投資家がポンジスキームの餌食になった。" },
    { word: "fall into one's lap", pos: "collocation", japanese: "思いがけず転がり込む", definition: "to come to someone without effort or planning", example: "The opportunity just fell into my lap.", exampleJa: "そのチャンスは思いがけず転がり込んできた。" },
    { word: "fall into a pattern", pos: "collocation", japanese: "パターンにはまる", definition: "to begin behaving in a habitual or repetitive way", example: "Teams often fall into a pattern of avoiding conflict.", exampleJa: "チームはしばしば衝突を避けるパターンにはまる。" },
    { word: "acquisition", pos: "noun", japanese: "買収", definition: "the act of buying a company or asset", example: "The acquisition was valued at two billion dollars.", exampleJa: "その買収は20億ドルと評価された。" },
    { word: "organic growth", pos: "noun", japanese: "自力成長（買収に頼らない成長）", definition: "business expansion achieved internally without mergers or acquisitions", example: "The firm prioritized organic growth over acquisitions.", exampleJa: "その会社は買収より自力成長を優先した。" },
...
,
{
  ...
  glossary: [
    { word: "go through the motions", pos: "collocation", japanese: "形だけやる、惰性でやる", definition: "to do something without real effort or enthusiasm", example: "He was just going through the motions at his job.", exampleJa: "彼は仕事を形だけやっていた。" },
    { word: "go along with", pos: "phrasal verb", japanese: "〜に従う、同意する", definition: "to agree with or accept someone's suggestion", example: "I'll go along with your decision this time.", exampleJa: "今回はあなたの決定に従います。" },
    { word: "go without saying", pos: "collocation", japanese: "言うまでもない", definition: "to be so obvious that it does not need to be stated", example: "It goes without saying that safety comes first.", exampleJa: "安全第一なのは言うまでもない。" },
    { word: "go over", pos: "phrasal verb", japanese: "〜を見直す、確認する", definition: "to review or examine something carefully", example: "Let's go over the contract one more time.", exampleJa: "契約書をもう一度確認しよう。" },
    { word: "go through", pos: "phrasal verb", japanese: "〜を経験する、〜を通過する", definition: "to experience something difficult or unpleasant", example: "She's going through a tough time at work.", exampleJa: "彼女は仕事でつらい時期を経験している。" },
    { word: "go the extra mile", pos: "collocation", japanese: "期待以上の努力をする", definition: "to make more effort than is expected", example: "Great employees always go the extra mile.", exampleJa: "優れた従業員は常に期待以上の努力をする。" },
    { word: "go out of one's way", pos: "collocation", japanese: "わざわざ〜する", definition: "to make a special effort to do something", example: "She went out of her way to help the new intern.", exampleJa: "彼女はわざわざ新しいインターンを助けた。" },
    { word: "go about", pos: "phrasal verb", japanese: "〜に取り組む、〜を進める", definition: "to begin or continue doing something in a particular way", example: "How should we go about solving this problem?", exampleJa: "この問題にどのように取り組むべきですか？" },
    { word: "go above and beyond", pos: "collocation", japanese: "期待を超えて頑張る", definition: "to do more than what is required or expected", example: "The support team went above and beyond for us.", exampleJa: "サポートチームは私たちのために期待を超えて頑張った。" },
    { word: "go unnoticed", pos: "collocation", japanese: "気づかれない", definition: "to not be seen or recognized by others", example: "Her hard work didn't go unnoticed by management.", exampleJa: "彼女の努力は経営陣に気づかれないままではなかった。" },
    { word: "cutting corners", pos: "collocation", japanese: "手抜きをする", definition: "to do something in the cheapest or easiest way, sacrificing quality", example: "Cutting corners on safety is never acceptable.", exampleJa: "安全面で手抜きをすることは決して許されない。" },
...
,
{
  ...
  glossary: [
    { word: "stand out", pos: "phrasal verb", japanese: "目立つ、際立つ", definition: "to be clearly better or more noticeable than others", example: "Her resume really stands out from the others.", exampleJa: "彼女の履歴書は他と比べて本当に際立っている。" },
    { word: "stand for", pos: "phrasal verb", japanese: "〜を象徴する、〜の立場をとる", definition: "to represent a principle or idea", example: "Our brand stands for quality and innovation.", exampleJa: "私たちのブランドは品質と革新を象徴している。" },
    { word: "stand corrected", pos: "collocation", japanese: "間違いを認める", definition: "to admit that you were wrong after being shown the truth", example: "I stand corrected—your figures were accurate.", exampleJa: "間違いを認めます——あなたの数字が正確でした。" },
    { word: "stand a chance", pos: "collocation", japanese: "見込みがある、可能性がある", definition: "to have a possibility of success", example: "Without funding, the startup doesn't stand a chance.", exampleJa: "資金なしでは、そのスタートアップに見込みはない。" },
    { word: "stand one's ground", pos: "collocation", japanese: "自分の立場を堅持する", definition: "to maintain your position firmly despite opposition", example: "She stood her ground during the negotiation.", exampleJa: "彼女は交渉中、自分の立場を堅持した。" },
    { word: "stand by", pos: "phrasal verb", japanese: "傍観する／支持する", definition: "to watch without intervening; or to remain loyal", example: "We won't stand by while clients lose money.", exampleJa: "クライアントがお金を失うのを傍観しません。" },
    { word: "stand the test of time", pos: "collocation", japanese: "時の試練に耐える", definition: "to remain effective or respected over a long period", example: "Only quality products stand the test of time.", exampleJa: "品質の高い製品だけが時の試練に耐える。" },
    { word: "stand behind", pos: "phrasal verb", japanese: "〜を支持する、〜を保証する", definition: "to support or guarantee something", example: "We stand behind every product we sell.", exampleJa: "私たちは販売するすべての製品を保証する。" },
    { word: "stand apart", pos: "phrasal verb", japanese: "一線を画す", definition: "to be clearly different or superior to others", example: "This candidate stands apart from the rest.", exampleJa: "この候補者は他と一線を画している。" },
    { word: "poach", pos: "verb", japanese: "引き抜く", definition: "to take someone's clients, employees, or ideas illegally or unfairly", example: "Rival firms tried to poach our top analysts.", exampleJa: "ライバル企業が当社のトップアナリストを引き抜こうとした。" },
...
,
{
  ...
  glossary: [
    { word: "work out", pos: "phrasal verb", japanese: "うまくいく／解決する", definition: "to have a good result; to be resolved successfully", example: "Don't worry—everything will work out fine.", exampleJa: "心配しないで——すべてうまくいくよ。" },
    { word: "work around", pos: "phrasal verb", japanese: "〜を回避する、迂回策を取る", definition: "to find a way to deal with a problem without solving it directly", example: "We found a way to work around the bug.", exampleJa: "そのバグを回避する方法を見つけた。" },
    { word: "work up to", pos: "phrasal verb", japanese: "徐々に〜に達する", definition: "to gradually increase to a higher level or more difficult task", example: "Start small and work up to larger goals.", exampleJa: "小さく始めてより大きな目標へ徐々に達しよう。" },
    { word: "work wonders", pos: "collocation", japanese: "驚くほどの効果がある", definition: "to have an extremely positive effect", example: "A good night's sleep works wonders for productivity.", exampleJa: "良い睡眠は生産性に驚くほどの効果がある。" },
    { word: "work up the courage", pos: "collocation", japanese: "勇気を奮い起こす", definition: "to gradually build the confidence to do something difficult", example: "It took me weeks to work up the courage to speak.", exampleJa: "話す勇気を奮い起こすのに数週間かかった。" },
    { word: "work through", pos: "phrasal verb", japanese: "〜を乗り越える、克服する", definition: "to deal with a problem or difficult experience step by step", example: "We need to work through these issues together.", exampleJa: "これらの問題を一緒に乗り越える必要がある。" },
    { word: "work in one's favor", pos: "collocation", japanese: "〜に有利に働く", definition: "to be advantageous to someone", example: "The delay actually worked in our favor.", exampleJa: "遅延は実際に私たちに有利に働いた。" },
    { word: "work at", pos: "phrasal verb", japanese: "〜に取り組み続ける", definition: "to keep trying to do or improve something", example: "Success comes to those who work at it consistently.", exampleJa: "成功は一貫して取り組み続ける者に訪れる。" },
    { word: "went sideways", pos: "collocation", japanese: "うまくいかなかった、想定外になった", definition: "to go wrong or not as planned", example: "The product launch went sideways due to supply issues.", exampleJa: "供給問題で製品ローンチがうまくいかなかった。" },
    { word: "rollout", pos: "noun", japanese: "展開、ロールアウト", definition: "the gradual introduction or launch of something new", example: "The software rollout was completed across all offices.", exampleJa: "ソフトウェアの展開が全オフィスで完了した。" },
...
,
{
  ...
  glossary: [
    { word: "draw on", pos: "phrasal verb", japanese: "〜を活用する、頼りにする", definition: "to use knowledge, experience, or resources from the past", example: "She drew on her years of training for the role.", exampleJa: "彼女はその役割のために長年のトレーニングを活用した。" },
    { word: "draw conclusions", pos: "collocation", japanese: "結論を導き出す", definition: "to form an opinion based on evidence or analysis", example: "It's too early to draw conclusions from the data.", exampleJa: "データから結論を導き出すには時期尚早だ。" },
    { word: "draw attention to", pos: "collocation", japanese: "〜に注意を向けさせる", definition: "to make people notice or focus on something", example: "The report drew attention to rising inequality.", exampleJa: "その報告書は拡大する不平等に注意を向けさせた。" },
    { word: "draw the line", pos: "collocation", japanese: "一線を引く、限度を設ける", definition: "to set a limit on what you will accept or tolerate", example: "I draw the line at working on weekends.", exampleJa: "週末に働くことには一線を引いている。" },
    { word: "draw out", pos: "phrasal verb", japanese: "〜を引き出す", definition: "to cause something to emerge or be revealed", example: "Good questions draw out honest answers.", exampleJa: "良い質問は正直な答えを引き出す。" },
    { word: "draw a clear picture", pos: "collocation", japanese: "明確な全体像を示す", definition: "to present information in a way that is easy to understand", example: "The data draws a clear picture of the problem.", exampleJa: "データが問題の明確な全体像を示している。" },
    { word: "draw up", pos: "phrasal verb", japanese: "〜を作成する、起草する", definition: "to prepare a document, plan, or agreement", example: "Our lawyers drew up the partnership agreement.", exampleJa: "弁護士がパートナーシップ契約を作成した。" },
    { word: "draw a contrast", pos: "collocation", japanese: "対比を浮き彫りにする", definition: "to highlight differences between two things", example: "The study draws a sharp contrast between the two groups.", exampleJa: "その研究は二つのグループの鮮明な対比を浮き彫りにしている。" },
    { word: "draw in", pos: "phrasal verb", japanese: "〜を引きつける", definition: "to attract or involve someone", example: "The campaign drew in thousands of new customers.", exampleJa: "そのキャンペーンは何千人もの新規顧客を引きつけた。" },
    { word: "turbulent", pos: "adjective", japanese: "激動の、波乱の", definition: "characterized by conflict, disorder, or rapid change", example: "The company went through a turbulent period of restructuring.", exampleJa: "会社は激動のリストラ期間を経験した。" },
    { word: "behavioral finance", pos: "noun", japanese: "行動ファイナンス", definition: "the study of how psychological factors affect financial decisions", example: "Behavioral finance explains why investors often act irrationally.", exampleJa: "行動ファイナンスは投資家がしばしば非合理的に行動する理由を説明する。" },
...
,
{
  ...
  glossary: [
    { word: "lay the groundwork", pos: "collocation", japanese: "基盤を築く", definition: "to do the basic work or preparation needed for something", example: "Early research laid the groundwork for the discovery.", exampleJa: "初期の研究がその発見の基盤を築いた。" },
    { word: "lie ahead", pos: "collocation", japanese: "〜が待ち受けている", definition: "to exist or be waiting in the future", example: "No one knows what challenges lie ahead.", exampleJa: "どんな課題が待ち受けているか誰にもわからない。" },
    { word: "lay off", pos: "phrasal verb", japanese: "〜を解雇する（一時的に）", definition: "to dismiss employees, usually due to economic reasons", example: "The factory laid off 200 workers last month.", exampleJa: "その工場は先月200人の労働者を解雇した。" },
    { word: "lie low", pos: "collocation", japanese: "目立たないようにする、潜伏する", definition: "to stay quiet and avoid attracting attention", example: "After the scandal, the politician decided to lie low.", exampleJa: "スキャンダルの後、その政治家は目立たないようにすることに決めた。" },
    { word: "lay out", pos: "phrasal verb", japanese: "〜を示す、説明する", definition: "to explain or present something clearly and in detail", example: "The proposal lays out the costs and benefits.", exampleJa: "その提案はコストと利点を明確に示している。" },
    { word: "lay bare", pos: "collocation", japanese: "〜をさらけ出す、暴露する", definition: "to reveal or expose something hidden or private", example: "The investigation laid bare years of corruption.", exampleJa: "調査が何年にもわたる汚職をさらけ出した。" },
    { word: "lies in", pos: "collocation", japanese: "〜にある、〜に存する", definition: "to exist or be found in a particular thing", example: "The solution lies in better communication.", exampleJa: "解決策はより良いコミュニケーションにある。" },
    { word: "lay down", pos: "phrasal verb", japanese: "〜を定める、規定する", definition: "to establish rules, principles, or standards officially", example: "The constitution lays down fundamental rights.", exampleJa: "憲法が基本的権利を定めている。" },
    { word: "paying dividends", pos: "collocation", japanese: "成果を上げている", definition: "producing good results over time", example: "Our early investment in training is paying dividends.", exampleJa: "トレーニングへの早期投資が成果を上げている。" },
    { word: "restructuring", pos: "noun", japanese: "組織再編", definition: "the process of reorganizing a company's structure or finances", example: "The restructuring reduced overhead costs by 30%.", exampleJa: "組織再編で間接費が30%削減された。" },
    { word: "transition", pos: "noun", japanese: "移行、過渡期", definition: "the process of changing from one state or condition to another", example: "The transition to remote work was smoother than expected.", exampleJa: "リモートワークへの移行は予想よりスムーズだった。" },
    { word: "reap what you sow", pos: "collocation", japanese: "自業自得（蒔いた種を刈り取る）", definition: "to experience the consequences of your own actions", example: "If you invest in people, you reap what you sow.", exampleJa: "人に投資すれば、蒔いた種を刈り取ることになる。" }
  ],
...
The prudent response is neither complacency nor prohibition, but deliberate adaptation: redesigning career ladders, subsidizing retraining, and ensuring that the surplus generated by automation is broadly shared rather than narrowly captured.`,
  glossary: [
    { word: "autonomously", pos: "adverb", japanese: "自律的に", definition: "Acting independently without direct human control", example: "The drone navigated autonomously through the warehouse.", exampleJa: "そのドローンは倉庫内を自律的に飛行した。" },
    { word: "reconcile", pos: "verb", japanese: "照合する、突き合わせる", definition: "To check that two sets of records agree with each other", example: "Accountants reconcile bank statements at every month-end.", exampleJa: "経理担当者は毎月末に銀行明細を照合する。" },
    { word: "proliferation", pos: "noun", japanese: "急増、拡散", definition: "Rapid increase in the number or amount of something", example: "The proliferation of streaming services fragmented the audience.", exampleJa: "動画配信サービスの急増が視聴者を分散させた。" },
    { word: "redraw the boundary", pos: "phrase", japanese: "境界線を引き直す", definition: "To change where the dividing line between two things lies", example: "Remote work redrew the boundary between office and home.", exampleJa: "リモートワークはオフィスと家庭の境界線を引き直した。" },
    { word: "tedious", pos: "adjective", japanese: "退屈な、単調な", definition: "Too long, slow, or dull; tiresome", example: "Manual data entry is tedious and error-prone.", exampleJa: "手作業のデータ入力は退屈でミスが起きやすい。" },
    { word: "stagnant", pos: "adjective", japanese: "停滞した", definition: "Showing no activity, growth, or development", example: "Wages remained stagnant despite corporate profits rising.", exampleJa: "企業利益が伸びても賃金は停滞したままだった。" },
    { word: "displacement", pos: "noun", japanese: "置き換え、雇用喪失", definition: "The forcing of workers out of their jobs by technology or change", example: "Automation caused significant displacement in manufacturing towns.", exampleJa: "自動化は製造業の町に大きな雇用喪失をもたらした。" },
    { word: "rung", pos: "noun", japanese: "（はしごの）段、階級", definition: "A level or step in a hierarchy, like a ladder step", example: "Internships are the first rung on the career ladder.", exampleJa: "インターンシップはキャリアのはしごの最初の段である。" },
    { word: "tacit", pos: "adjective", japanese: "暗黙の", definition: "Understood or implied without being stated openly", example: "Veteran traders rely on tacit knowledge of market moods.", exampleJa: "ベテラントレーダーは市場心理に関する暗黙知に頼る。" },
    { word: "wrenching", pos: "adjective", japanese: "苦痛を伴う、つらい", definition: "Causing great emotional or social pain", example: "The factory closure was a wrenching experience for the town.", exampleJa: "工場閉鎖は町にとって苦痛を伴う経験だった。" },
    { word: "hollow out", pos: "phrasal verb", japanese: "空洞化させる", definition: "To remove the essential middle part of something, weakening it", example: "Cheap imports hollowed out the domestic textile industry.", exampleJa: "安価な輸入品が国内繊維産業を空洞化させた。" },
    { word: "complacency", pos: "noun", japanese: "自己満足、慢心", definition: "Smug satisfaction that prevents awareness of danger", example: "Complacency after early success led to the startup's downfall.", exampleJa: "初期の成功後の慢心がそのスタートアップの凋落を招いた。" },
    { word: "surplus", pos: "noun", japanese: "余剰、黒字", definition: "An amount left over when requirements have been met", example: "The productivity surplus was distributed as higher dividends.", exampleJa: "生産性の余剰はより高い配当として分配された。" }
  ],
...
The resolution will likely combine price negotiation, generic competition upon patent expiry, and outcome-based contracts that tie reimbursement to demonstrated health improvements.`,
  glossary: [
    { word: "receptor agonist", pos: "noun", japanese: "受容体作動薬", definition: "A drug that activates a specific receptor to produce a biological response", example: "The receptor agonist mimics a natural gut hormone.", exampleJa: "その受容体作動薬は天然の消化管ホルモンを模倣する。" },
    { word: "efficacious", pos: "adjective", japanese: "効果的な、効能のある", definition: "Successful in producing a desired or intended result", example: "The vaccine proved highly efficacious in clinical trials.", exampleJa: "そのワクチンは臨床試験で高い効果を示した。" },
    { word: "actuarial", pos: "adjective", japanese: "保険数理の", definition: "Relating to the statistical calculation of risk and premiums", example: "Actuarial tables estimate life expectancy for insurers.", exampleJa: "保険数理表は保険会社のために平均余命を推定する。" },
    { word: "indefinitely", pos: "adverb", japanese: "無期限に", definition: "For an unlimited or unspecified period of time", example: "The project was postponed indefinitely due to funding cuts.", exampleJa: "そのプロジェクトは資金削減のため無期限に延期された。" },
    { word: "staggering", pos: "adjective", japanese: "途方もない、驚異的な", definition: "Deeply shocking or astonishingly large", example: "The merger involved a staggering sum of money.", exampleJa: "その合併は途方もない金額を伴った。" },
    { word: "ration", pos: "verb", japanese: "配給制にする、制限する", definition: "To limit the amount of something people are allowed to have", example: "Hospitals rationed intensive-care beds during the surge.", exampleJa: "感染拡大時、病院は集中治療ベッドを制限した。" },
    { word: "prior authorization", pos: "noun", japanese: "事前承認", definition: "Insurer approval required before a treatment is covered", example: "The specialist obtained prior authorization for the scan.", exampleJa: "専門医はスキャンの事前承認を取得した。" },
    { word: "proponent", pos: "noun", japanese: "支持者、提唱者", definition: "A person who advocates for a policy or idea", example: "Proponents of the tax cite its environmental benefits.", exampleJa: "その税の支持者は環境面の利点を挙げる。" },
    { word: "curtail", pos: "verb", japanese: "削減する、抑制する", definition: "To reduce or impose a restriction on something", example: "New rules curtailed speculative trading by banks.", exampleJa: "新規則は銀行の投機的取引を抑制した。" },
    { word: "downstream", pos: "adjective", japanese: "下流の、後々の", definition: "Occurring at a later stage of a process", example: "Early screening reduces downstream treatment costs.", exampleJa: "早期検診は後々の治療費を削減する。" },
    { word: "accrue", pos: "verb", japanese: "（利益などが）生じる、蓄積する", definition: "To accumulate or be received over time", example: "Interest accrues daily on the outstanding balance.", exampleJa: "利息は未払い残高に対して日々発生する。" },
    { word: "temporal mismatch", pos: "noun", japanese: "時間的ミスマッチ", definition: "A misalignment between when costs and benefits occur", example: "Pension funding suffers from a temporal mismatch problem.", exampleJa: "年金財政は時間的ミスマッチの問題を抱えている。" },
    { word: "reimbursement", pos: "noun", japanese: "償還、払い戻し", definition: "Payment made to cover expenses already incurred", example: "The clinic sought reimbursement from the national insurer.", exampleJa: "その診療所は公的保険者に償還を求めた。" }
  ],
...
Restoring sustainability requires some combination of primary surpluses, structural growth reforms, and occasionally financial repression—channeling captive domestic savings into government paper at suppressed yields. Each path imposes distributional costs that electorates, already weary of austerity, may prove unwilling to bear.`,
  glossary: [
    { word: "negligible", pos: "adjective", japanese: "無視できるほどの", definition: "So small as to be not worth considering", example: "The fee's impact on returns was negligible.", exampleJa: "その手数料がリターンに与える影響は無視できるほどだった。" },
    { word: "benign", pos: "adjective", japanese: "無害な、良性の", definition: "Gentle and harmless; not threatening", example: "The inflation reading was benign, calming bond markets.", exampleJa: "インフレ指標は無害な水準で、債券市場を落ち着かせた。" },
    { word: "term premium", pos: "noun", japanese: "タームプレミアム（期間プレミアム）", definition: "Extra yield investors demand for holding longer-maturity bonds", example: "A rising term premium steepened the yield curve.", exampleJa: "タームプレミアムの上昇がイールドカーブをスティープ化させた。" },
    { word: "debt service", pos: "noun", japanese: "債務返済（元利払い）", definition: "The cash required to pay interest and principal on debt", example: "Debt service now exceeds the defense budget.", exampleJa: "債務の元利払いは今や国防予算を上回る。" },
    { word: "unforgiving", pos: "adjective", japanese: "容赦のない", definition: "Allowing no room for error or weakness", example: "Currency markets are unforgiving of policy mistakes.", exampleJa: "為替市場は政策の失敗に容赦がない。" },
    { word: "ratchet upward", pos: "phrasal verb", japanese: "段階的に上昇する", definition: "To increase steadily in a way that is hard to reverse", example: "Rents ratcheted upward as supply stayed tight.", exampleJa: "供給が逼迫したままで家賃は段階的に上昇した。" },
    { word: "maturity", pos: "noun", japanese: "満期", definition: "The date on which a debt becomes due for payment", example: "The treasury extended the average maturity of its debt.", exampleJa: "財務省は債務の平均満期を延長した。" },
    { word: "profligate", pos: "adjective/noun", japanese: "浪費的な（国・人）", definition: "Recklessly extravagant or wasteful with resources", example: "Markets punished the profligate government with higher yields.", exampleJa: "市場は浪費的な政府をより高い利回りで罰した。" },
    { word: "latitude", pos: "noun", japanese: "裁量の余地、自由度", definition: "Freedom of action or scope for maneuver", example: "The central bank has little latitude when inflation is high.", exampleJa: "インフレが高いとき中央銀行の裁量の余地は小さい。" },
    { word: "risk premia", pos: "noun", japanese: "リスクプレミアム（複数形）", definition: "Extra returns demanded for bearing risk (plural of premium)", example: "Political turmoil widened risk premia on local bonds.", exampleJa: "政治的混乱は現地債券のリスクプレミアムを拡大させた。" },
    { word: "falter", pos: "verb", japanese: "揺らぐ、弱まる", definition: "To lose strength or momentum; to hesitate", example: "Investor confidence faltered after the budget announcement.", exampleJa: "予算発表後、投資家の信頼は揺らいだ。" },
    { word: "primary surplus", pos: "noun", japanese: "プライマリーバランス黒字", definition: "A budget surplus excluding interest payments on debt", example: "Achieving a primary surplus stabilized the debt ratio.", exampleJa: "プライマリーバランス黒字の達成が債務比率を安定させた。" },
    { word: "financial repression", pos: "noun", japanese: "金融抑圧", definition: "Policies channeling cheap domestic funds to the government", example: "Financial repression eroded savers' real returns for decades.", exampleJa: "金融抑圧は数十年にわたり貯蓄者の実質リターンを侵食した。" },
    { word: "austerity", pos: "noun", japanese: "緊縮財政", definition: "Severe cuts in government spending to reduce deficits", example: "Austerity sparked mass protests across the country.", exampleJa: "緊縮財政は全国で大規模な抗議を引き起こした。" }
  ],
...
None of this guarantees a crisis. But opacity means distress may remain concealed until refinancing walls arrive. Regulators, mindful that risk has migrated rather than vanished, are belatedly demanding greater transparency from a sector built on discretion.`,
  glossary: [
    { word: "retrench", pos: "verb", japanese: "縮小する、緊縮する", definition: "To reduce costs or activities in response to difficulty", example: "The bank retrenched, exiting several overseas markets.", exampleJa: "その銀行は事業を縮小し、複数の海外市場から撤退した。" },
    { word: "vacuum", pos: "noun", japanese: "空白、真空", definition: "A gap left by the absence of something", example: "New lenders filled the vacuum left by retreating banks.", exampleJa: "新しい貸し手が撤退する銀行の残した空白を埋めた。" },
    { word: "balloon", pos: "verb", japanese: "急膨張する", definition: "To increase rapidly in size or amount", example: "The deficit ballooned during the recession.", exampleJa: "景気後退の間に財政赤字は急膨張した。" },
    { word: "floating-rate", pos: "adjective", japanese: "変動金利の", definition: "Having an interest rate that adjusts with market benchmarks", example: "Floating-rate loans benefit lenders when rates rise.", exampleJa: "変動金利ローンは金利上昇時に貸し手に有利に働く。" },
    { word: "insulation", pos: "noun", japanese: "遮断、絶縁", definition: "Protection from outside influences or shocks", example: "Diversification offers some insulation from single-market shocks.", exampleJa: "分散投資は単一市場のショックからの一定の遮断を提供する。" },
    { word: "artifact", pos: "noun", japanese: "人為的産物、見かけ上の結果", definition: "A result arising from the method of measurement rather than reality", example: "The smooth returns were an artifact of stale pricing.", exampleJa: "滑らかなリターンは古い価格評価の人為的産物だった。" },
    { word: "deceptively", pos: "adverb", japanese: "見かけによらず、欺くように", definition: "In a way that gives a misleading impression", example: "The strategy looked deceptively safe in backtests.", exampleJa: "その戦略はバックテストでは見かけによらず安全に見えた。" },
    { word: "volatility laundering", pos: "noun", japanese: "ボラティリティ・ロンダリング", definition: "Masking true risk by using infrequent or smoothed valuations", example: "Critics accuse private funds of volatility laundering.", exampleJa: "批判者はプライベートファンドをボラティリティ・ロンダリングだと非難する。" },
    { word: "placid", pos: "adjective", japanese: "穏やかな、平穏な", definition: "Calm and peaceful, with little movement", example: "Beneath the placid surface, tensions were building.", exampleJa: "穏やかな表面の下で緊張が高まっていた。" },
    { word: "covenant", pos: "noun", japanese: "コベナンツ（財務制限条項）", definition: "A contractual clause protecting lenders by restricting borrower actions", example: "The loan's covenants limit additional borrowing.", exampleJa: "そのローンのコベナンツは追加借入を制限している。" },
    { word: "payment-in-kind", pos: "noun", japanese: "現物払い（PIK）", definition: "Interest paid by issuing more debt instead of cash", example: "Payment-in-kind notes defer cash interest to maturity.", exampleJa: "PIK債は現金利払いを満期まで繰り延べる。" },
    { word: "opacity", pos: "noun", japanese: "不透明性", definition: "The quality of being difficult to see through or understand", example: "The market's opacity hindered regulators' oversight.", exampleJa: "その市場の不透明性が規制当局の監視を妨げた。" },
    { word: "refinancing wall", pos: "noun", japanese: "借り換えの壁", definition: "A large volume of debt maturing around the same time", example: "A refinancing wall looms for leveraged borrowers in 2027.", exampleJa: "2027年にはレバレッジの高い借り手に借り換えの壁が迫る。" },
    { word: "belatedly", pos: "adverb", japanese: "遅ればせながら", definition: "Later than should have been the case", example: "The agency belatedly tightened its reporting rules.", exampleJa: "当局は遅ればせながら報告規則を厳格化した。" }
  ],
...
The unavoidable conclusion is that mineral security now sits alongside energy security in national strategy. Countries that ignore the vulnerability do so at their peril, for the age of geologically indifferent globalization has ended.`,
  glossary: [
    { word: "obscure", pos: "adjective", japanese: "無名の、目立たない", definition: "Not well known; not important or famous", example: "An obscure metal suddenly became strategically vital.", exampleJa: "無名の金属が突如として戦略的に重要になった。" },
    { word: "rare earths", pos: "noun", japanese: "レアアース（希土類）", definition: "A group of 17 metallic elements essential for high-tech products", example: "Magnets in EV motors depend on rare earths.", exampleJa: "EVモーターの磁石はレアアースに依存している。" },
    { word: "hinge on", pos: "phrasal verb", japanese: "〜次第である、〜にかかっている", definition: "To depend entirely on something", example: "The deal hinges on regulatory approval.", exampleJa: "その取引は規制当局の承認にかかっている。" },
    { word: "extraction", pos: "noun", japanese: "採掘、抽出", definition: "The process of removing minerals from the ground", example: "Lithium extraction consumes vast quantities of water.", exampleJa: "リチウム採掘は大量の水を消費する。" },
    { word: "confer", pos: "verb", japanese: "与える、付与する", definition: "To grant or bestow a benefit, power, or quality", example: "Market dominance confers significant pricing power.", exampleJa: "市場支配は大きな価格決定力を与える。" },
    { word: "statecraft", pos: "noun", japanese: "国政術、外交手腕", definition: "The skillful management of state affairs and foreign relations", example: "Trade policy became a central tool of statecraft.", exampleJa: "通商政策は国政術の中心的な道具となった。" },
    { word: "scramble", pos: "verb", japanese: "先を争って動く、奔走する", definition: "To move or act urgently and competitively", example: "Automakers scrambled to secure battery contracts.", exampleJa: "自動車メーカーは電池契約の確保に奔走した。" },
    { word: "friend-shoring", pos: "noun", japanese: "フレンドショアリング（同盟国への供給網移転）", definition: "Relocating supply chains to politically allied countries", example: "Friend-shoring reshaped semiconductor investment flows.", exampleJa: "フレンドショアリングは半導体投資の流れを再構築した。" },
    { word: "stockpile", pos: "noun", japanese: "備蓄", definition: "A large reserve supply held for future use", example: "The government released oil from its strategic stockpile.", exampleJa: "政府は戦略備蓄から石油を放出した。" },
    { word: "lavish", pos: "adjective", japanese: "気前のよい、豪華な", definition: "Given generously or in large amounts", example: "The state offered lavish incentives to chipmakers.", exampleJa: "州は半導体メーカーに気前のよい優遇策を提示した。" },
    { word: "proclaim", pos: "verb", japanese: "宣言する、公言する", definition: "To announce something publicly or officially", example: "Leaders proclaimed a new era of industrial policy.", exampleJa: "指導者たちは産業政策の新時代を宣言した。" },
    { word: "contentious", pos: "adjective", japanese: "論争を呼ぶ", definition: "Causing or likely to cause disagreement", example: "The mine's approval was politically contentious.", exampleJa: "その鉱山の認可は政治的に論争を呼んだ。" },
    { word: "at one's peril", pos: "phrase", japanese: "自らの危険を覚悟で", definition: "With the risk of serious harm to oneself", example: "Investors ignore liquidity risk at their peril.", exampleJa: "投資家が流動性リスクを無視すれば自らが危険を被る。" },
    { word: "indifferent", pos: "adjective", japanese: "無関心な、無頓着な", definition: "Having no particular interest or concern", example: "Globalization was once indifferent to geography.", exampleJa: "かつてグローバル化は地理に無頓着だった。" }
  ],
...
The countries navigating the transition most successfully combine gradualism with automatic stabilizers: indexing retirement ages to longevity and adjusting benefits by formula, thereby insulating painful decisions from electoral cycles.`,
  glossary: [
    { word: "fertility rate", pos: "noun", japanese: "出生率", definition: "The average number of children born per woman", example: "The fertility rate fell below one in some cities.", exampleJa: "一部の都市では出生率が1を下回った。" },
    { word: "replacement level", pos: "noun", japanese: "人口置換水準", definition: "The birth rate needed to keep a population stable (about 2.1)", example: "Few developed nations reach replacement level today.", exampleJa: "今日、人口置換水準に達する先進国はほとんどない。" },
    { word: "pay-as-you-go", pos: "adjective", japanese: "賦課方式の", definition: "Funded by current contributions rather than accumulated savings", example: "Pay-as-you-go pensions depend on a large workforce.", exampleJa: "賦課方式の年金は大きな労働力人口に依存する。" },
    { word: "deteriorate", pos: "verb", japanese: "悪化する", definition: "To become progressively worse", example: "The fund's finances deteriorated as members retired.", exampleJa: "加入者の退職に伴い基金の財政は悪化した。" },
    { word: "beneficiary", pos: "noun", japanese: "受給者、受益者", definition: "A person who receives benefits or payments", example: "The number of beneficiaries doubled in two decades.", exampleJa: "受給者数は20年で倍増した。" },
    { word: "remedy", pos: "noun", japanese: "解決策、救済策", definition: "A means of correcting or counteracting a problem", example: "There is no painless remedy for the funding gap.", exampleJa: "財源不足に痛みのない解決策はない。" },
    { word: "prefund", pos: "verb", japanese: "事前積立する", definition: "To set aside money in advance for future obligations", example: "The state prefunded pensions through a reserve fund.", exampleJa: "国は積立基金を通じて年金を事前積立した。" },
    { word: "treacherous", pos: "adjective", japanese: "危険な、油断ならない", definition: "Full of hidden dangers; hazardous", example: "Entitlement reform is treacherous terrain for politicians.", exampleJa: "社会保障改革は政治家にとって油断ならない領域だ。" },
    { word: "topple", pos: "verb", japanese: "倒す、失脚させる", definition: "To cause a government or leader to fall from power", example: "The unpopular tax toppled the coalition government.", exampleJa: "不人気な税が連立政権を倒した。" },
    { word: "dwarf", pos: "verb", japanese: "〜を小さく見せる、圧倒する", definition: "To make something seem small by comparison", example: "Senior turnout dwarfs that of first-time voters.", exampleJa: "高齢者の投票率は初回投票者のそれを圧倒する。" },
    { word: "formidable", pos: "adjective", japanese: "手ごわい、侮れない", definition: "Inspiring fear or respect through power or capability", example: "Retiree associations are a formidable lobbying force.", exampleJa: "退職者団体は手ごわいロビー勢力である。" },
    { word: "compound", pos: "verb", japanese: "悪化させる、複利的に増やす", definition: "To make a problem worse; to accumulate like interest", example: "Inaction compounds the eventual fiscal adjustment.", exampleJa: "無策は最終的な財政調整の負担を悪化させる。" },
    { word: "intergenerational equity", pos: "noun", japanese: "世代間公平", definition: "Fairness in distributing burdens and benefits across generations", example: "Debt-financed benefits raise questions of intergenerational equity.", exampleJa: "借金で賄う給付は世代間公平の問題を提起する。" },
    { word: "gradualism", pos: "noun", japanese: "漸進主義", definition: "A policy of achieving change in small, steady steps", example: "Gradualism made the painful reform politically survivable.", exampleJa: "漸進主義がその痛みを伴う改革を政治的に存続可能にした。" },
    { word: "automatic stabilizer", pos: "noun", japanese: "自動安定化装置", definition: "A built-in mechanism that adjusts policy without new legislation", example: "Indexing acts as an automatic stabilizer for pensions.", exampleJa: "指数連動は年金の自動安定化装置として機能する。" }
  ],
